...
board_project_dir = os.path.join(board_notebooks_dir, 'rfsoc_ofdm')
data_files = []
...
def copy_overlays():
    ...
    dst_ol_dir = os.path.join('rfsoc_ofdm', 'bitstream')
...
def copy_assets():
    ...
    dst_at_dir = os.path.join('rfsoc_ofdm', 'assets')
...
def copy_drivers():
    ...
    dst_dr_dir = os.path.join('rfsoc_ofdm')
