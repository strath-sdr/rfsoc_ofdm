...
ARCHITECTURE rtl OF ofdm_tx_src_SymbolsGen IS
  ...
  SIGNAL BPSKmap_out1_re_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL BPSKmap_out1_im_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL QPSKMap_out1_re_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL QPSKMap_out1_im_1                : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL alpha16QAMMap_out1_re_1          : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL alpha16QAMMap_out1_im_1          : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      BPSKmap_out1_re_1 <= to_signed(16#0000#, 16);
      BPSKmap_out1_im_1 <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        BPSKmap_out1_re_1 <= BPSKmap_out1_re_signed;
        BPSKmap_out1_im_1 <= BPSKmap_out1_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      QPSKMap_out1_re_1 <= to_signed(16#0000#, 16);
      QPSKMap_out1_im_1 <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        QPSKMap_out1_re_1 <= QPSKMap_out1_re_signed;
        QPSKMap_out1_im_1 <= QPSKMap_out1_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      alpha16QAMMap_out1_re_1 <= to_signed(16#0000#, 16);
      alpha16QAMMap_out1_im_1 <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        alpha16QAMMap_out1_re_1 <= alpha16QAMMap_out1_re_signed;
        alpha16QAMMap_out1_im_1 <= alpha16QAMMap_out1_im_signed;
      END IF;
    END IF;
  ...
  Multiport_Switch_out1_re <= BPSKmap_out1_re_1 WHEN modScheme_unsigned = to_unsigned(16#0#, 2) ELSE
      QPSKMap_out1_re_1 WHEN modScheme_unsigned = to_unsigned(16#1#, 2) ELSE
      alpha16QAMMap_out1_re_1;
  
  Multiport_Switch_out1_im <= BPSKmap_out1_im_1 WHEN modScheme_unsigned = to_unsigned(16#0#, 2) ELSE
      QPSKMap_out1_im_1 WHEN modScheme_unsigned = to_unsigned(16#1#, 2) ELSE
      alpha16QAMMap_out1_im_1;
