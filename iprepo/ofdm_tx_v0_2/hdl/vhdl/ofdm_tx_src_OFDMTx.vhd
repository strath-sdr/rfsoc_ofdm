...
ARCHITECTURE rtl OF ofdm_tx_src_OFDMTx IS
  ...
  SIGNAL enb_1_192_1                      : std_logic;
  SIGNAL enb_1_192_0                      : std_logic;
  SIGNAL enb_1_16_1                       : std_logic;
  SIGNAL modScheme_unsigned               : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL Downsample_out1                  : unsigned(1 DOWNTO 0);  -- ufix2
  SIGNAL Downsample_out1_1                : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  SIGNAL Relational_Operator_1_cast       : unsigned(3 DOWNTO 0);  -- ufix4
  SIGNAL Relational_Operator_relop1       : std_logic;
  SIGNAL delayMatch_reg                   : std_logic_vector(0 TO 83);  -- ufix1 [84]
...
BEGIN
  ...
  u_DataGenerator : ofdm_tx_src_DataGenerator
    PORT MAP( clk => clk,
              ...
              enb_1_192_1 => enb_1_192_1,
              enb_1_192_0 => enb_1_192_0,
              modScheme => std_logic_vector(Downsample_out1_1),  -- ufix2
              dataValid => ControlSignalGenerator_out1,
              preambleValid => ControlSignalGenerator_out2,
              dataReady => ControlSignalGenerator_out3,
              pilotValid => ControlSignalGenerator_out4,
  ...
  BEGIN
    IF reset = '1' THEN
      Downsample_out1 <= to_unsigned(16#0#, 2);
  ...
  BEGIN
    IF reset = '1' THEN
      Downsample_out1_1 <= to_unsigned(16#0#, 2);
    ELSIF clk'EVENT AND clk = '1' THEN
  ...
  Bit_Concat_out1_1 <= Bit_Concat_out1 WHEN enb_1_192_1 = '1' ELSE
  ...
  Relational_Operator_1_cast <= '0' & '0' & '0' & Constant1_out1;
  
  Relational_Operator_relop1 <= '1' WHEN HDL_Counter_out1 = Relational_Operator_1_cast ELSE
      '0';
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        ...
        delayMatch_reg(1 TO 83) <= delayMatch_reg(0 TO 82);
      END IF;
    END IF;
  END PROCESS delayMatch_process;

  Relational_Operator_out1 <= delayMatch_reg(83);
