-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_RF_Signal_Generator.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/DataGenerator/RF Signal Generator
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_tx_src_RF_Signal_Generator IS
  ...
  -- Signals
  SIGNAL Random_Generator_out1            : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  u_Random_Generator : ofdm_tx_src_Random_Generator
    PORT MAP( clk => clk,
              ...
              Reset_1 => Reset_1,
              Enable => Enable,
              Data => Random_Generator_out1  -- uint8
              );
