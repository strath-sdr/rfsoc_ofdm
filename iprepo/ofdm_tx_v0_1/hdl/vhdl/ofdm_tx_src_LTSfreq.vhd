-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_LTSfreq.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/DataGenerator/LTSfreq
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Compare_To_Constant_out1 <= '1' WHEN HDL_Counter1_out1 >= to_unsigned(16#100#, 9) ELSE
      '0';

  
  Compare_To_Constant1_out1 <= '1' WHEN HDL_Counter1_out1 <= to_unsigned(16#13F#, 9) ELSE
      '0';

  AND_out1 <= Compare_To_Constant_out1 AND Compare_To_Constant1_out1;

  AND1_out1 <= AND_out1 AND preambVal;
  ...
  LTSFreq_k <= to_unsigned(16#00#, 6) WHEN HDL_Counter4_out1 = to_unsigned(16#00#, 6) ELSE
      to_unsigned(16#3F#, 6) WHEN HDL_Counter4_out1 = to_unsigned(16#3F#, 6) ELSE
      HDL_Counter4_out1;
