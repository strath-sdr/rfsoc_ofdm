-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_STFExtend.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/CPAdd/STFExtend
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      STFValidGen_out1_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        STFValidGen_out1_1 <= STFValidGen_out1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        reduced_reg(0) <= STFValidGen_out1_1;
        reduced_reg(1 TO 158) <= reduced_reg(0 TO 157);
      END IF;
    END IF;
  END PROCESS reduced_1_process;

  STFValidGen_out1_2 <= reduced_reg(158);
