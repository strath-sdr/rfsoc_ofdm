-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_PilotGen.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/DataGenerator/PilotGen
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Polarity_LUT_k <= to_unsigned(16#00#, 7) WHEN HDL_Counter2_out1 = to_unsigned(16#00#, 7) ELSE
      to_unsigned(16#7E#, 7) WHEN HDL_Counter2_out1 >= to_unsigned(16#7E#, 7) ELSE
      HDL_Counter2_out1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' AND pilotValidIn = '1' THEN
  ...
  PilotValue_LUT_k <= to_unsigned(16#0#, 2) WHEN HDL_Counter_out1 = to_unsigned(16#0#, 2) ELSE
      to_unsigned(16#3#, 2) WHEN HDL_Counter_out1 = to_unsigned(16#3#, 2) ELSE
      HDL_Counter_out1;
  ...
  Switch1_out1 <= Constant_out1 WHEN pilotValidIn_1 = '0' ELSE
