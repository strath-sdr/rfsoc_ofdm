-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_LTFExtend.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/CPAdd/LTFExtend
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  u_READ_CTRL : ofdm_tx_src_READ_CTRL
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_192_0 => enb_1_192_0,
              In1 => std_logic_vector(readaddr_out1_1),  -- uint8
              In2 => LTFValidGen_out1_2,
  ...
  BEGIN
    IF reset = '1' THEN
      HDL_Counter3_out1_1 <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      LTFValidGen_out1_1 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        LTFValidGen_out1_1 <= LTFValidGen_out1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        reduced_reg(0) <= LTFValidGen_out1_1;
        reduced_reg(1 TO 158) <= reduced_reg(0 TO 157);
      END IF;
    END IF;
  END PROCESS reduced_1_process;

  LTFValidGen_out1_2 <= reduced_reg(158);
  ...
  readaddr_k <= to_unsigned(16#00#, 8) WHEN HDL_Counter2_out1 = to_unsigned(16#00#, 8) ELSE
      to_unsigned(16#9F#, 8) WHEN HDL_Counter2_out1 >= to_unsigned(16#9F#, 8) ELSE
      HDL_Counter2_out1;
