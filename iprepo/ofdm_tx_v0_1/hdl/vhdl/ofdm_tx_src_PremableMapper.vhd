-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_PremableMapper.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/SCMapper/PremableMapper
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_READ_CTRL : ofdm_tx_src_READ_CTRL_block1
    PORT MAP( clk => clk,
              ...
              In1 => std_logic_vector(readaddr_out1_1),  -- ufix9
              In2 => preambVal_2,
  ...
  readaddr_k <= to_unsigned(16#000#, 9) WHEN HDL_Counter2_out1 = to_unsigned(16#000#, 9) ELSE
      to_unsigned(16#13F#, 9) WHEN HDL_Counter2_out1 >= to_unsigned(16#13F#, 9) ELSE
      HDL_Counter2_out1;
