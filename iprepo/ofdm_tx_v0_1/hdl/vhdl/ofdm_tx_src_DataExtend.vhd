-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_DataExtend.vhd
-- Created: 2021-01-08 12:14:21
-- 
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/CPAdd/DataExtend
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_READ_CTRL2 : ofdm_tx_src_READ_CTRL2
    PORT MAP( clk => clk,
              ...
              In1 => std_logic_vector(READ_ADDRESS_out1_1),  -- uint8
              In2 => dataValid_2,
  ...
  READ_ADDRESS_k <= to_unsigned(16#00#, 8) WHEN HDL_Counter_out1 = to_unsigned(16#00#, 8) ELSE
      to_unsigned(16#9F#, 8) WHEN HDL_Counter_out1 >= to_unsigned(16#9F#, 8) ELSE
      HDL_Counter_out1;
