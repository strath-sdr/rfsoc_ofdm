-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_SCMapper.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/SCMapper
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  u_Mux2 : ofdm_tx_src_Mux2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_192_0 => enb_1_192_0,
              preamb_re => PremableMapper_out1_re,  -- sfix16_En14
              preamb_im => PremableMapper_out1_im,  -- sfix16_En14
              preambVal => PremableMapper_out2,
              data_re => DataMapper_out1_re,  -- sfix16_En14
              data_im => DataMapper_out1_im,  -- sfix16_En14
              dataVal => DataMapper_out2,
  ...
  preambValidOut <= PremableMapper_out2_1;

  dataValidOut <= DataMapper_out2_1;
