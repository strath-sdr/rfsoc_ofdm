-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_WaveformGen.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/CoarseFreqCorr/NCO HDL Optimized/WaveformGen
-- Hierarchy Level: 4
-- 
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      validcnt <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' AND validEnb = '1' THEN
