-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_Sq.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_Sq
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/SchmidlCoxMetric /Sq
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_Sq IS

  -- Signals
  SIGNAL In1_signed                       : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Delay_out1                       : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Delay_out1_1                     : signed(17 DOWNTO 0);  -- sfix18_En16
  SIGNAL Delay_out1_2                     : signed(17 DOWNTO 0);  -- sfix18_En16
...
BEGIN
  ...
  Product_out1_2 <= Product_out1_1 WHEN enb_1_192_1 = '1' ELSE
      Delay1_bypass_reg;
