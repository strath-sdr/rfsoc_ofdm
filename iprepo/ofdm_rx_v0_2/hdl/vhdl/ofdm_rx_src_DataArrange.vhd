...
BEGIN
  ...
  dataValidIn_3 <= dataValidIn_2 WHEN enb_1_192_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' AND Delay_out1 = '1' THEN
  ...
  Dual_Port_RAM_out2_re_3 <= Dual_Port_RAM_out2_re_2 WHEN enb_1_192_1 = '1' ELSE
      Delay10_bypass_reg_re;
  
  Dual_Port_RAM_out2_im_3 <= Dual_Port_RAM_out2_im_2 WHEN enb_1_192_1 = '1' ELSE
