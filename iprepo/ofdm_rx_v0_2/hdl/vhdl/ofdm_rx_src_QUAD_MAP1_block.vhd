-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_QUAD_MAP1_block.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_2/CordicRotate/QCORR/QUAD_MAP1
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  OFDM_Rx_c13_QUAD_MAP1_output : PROCESS (ctrl_unsigned, xin_signed, yin_signed)
  ...
  BEGIN
    ...
    ELSE 
      ...
      yout_tmp <= yin_signed;
    END IF;
  END PROCESS OFDM_Rx_c13_QUAD_MAP1_output;
