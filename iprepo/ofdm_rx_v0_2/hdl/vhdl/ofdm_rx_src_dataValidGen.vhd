-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_dataValidGen.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_1/DataArrange/dataValidGen
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  AND_out1 <= Compare_To_Constant_out1 AND enb;
