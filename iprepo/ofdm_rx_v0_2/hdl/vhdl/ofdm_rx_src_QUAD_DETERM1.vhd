-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_QUAD_DETERM1.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_1/CordicRotate/QUAD_MAP/QUAD_DETERM1
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  OFDM_Rx_c7_QUAD_DETERM1_output : PROCESS (ang_in_signed)
  ...
  BEGIN
    ...
    END CASE;
    QUAD_tmp <= QUAD1;
  END PROCESS OFDM_Rx_c7_QUAD_DETERM1_output;
