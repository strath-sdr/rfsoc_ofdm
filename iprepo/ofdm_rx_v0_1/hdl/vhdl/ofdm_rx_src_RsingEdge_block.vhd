-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_RsingEdge_block.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/FrameDetect/RsingEdge
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        ...
        ELSIF Relational_Operator_relop1 = '1' THEN
          Unit_Delay_Enabled_Resettable_Synchronous_out1 <= Constant_out1;
        END IF;
      END IF;
    END IF;
