-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_FrameDetect.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/FrameDetect
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_FrameDetect IS
  ...
  SIGNAL Delay3_out1                      : signed(32 DOWNTO 0);  -- sfix33_En23
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay3_out1 <= to_signed(0, 33);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Delay3_out1 <= rightIn_signed;
      END IF;
    END IF;
  ...
  Relational_Operator_1_cast_1 <= Delay3_out1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0';
