-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_AutoCorr.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/SchmidlCoxMetric /AutoCorr
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Delay4_out1_re <= Math_Function_out1_re;
        Delay4_out1_im <= Math_Function_out1_im;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Product_C2ReIm_2_C2ReIm_A <= Delay4_out1_re;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Product_C2ReIm_1_C2ReIm_B <= Delay1_out1_im_1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Product_C2ReIm_2_C2ReIm_B <= Delay4_out1_im;
      END IF;
    END IF;
