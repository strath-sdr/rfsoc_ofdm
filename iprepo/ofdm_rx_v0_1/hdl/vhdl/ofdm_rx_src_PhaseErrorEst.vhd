-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_PhaseErrorEst.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_1/PhaseErrorEst
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_PhaseErrorEst IS
  ...
  SIGNAL HwModeRegister_reg               : vector_of_signed23(0 TO 1);  -- sfix23 [2]
  ...
  SIGNAL HwModeRegister1_reg              : vector_of_signed6(0 TO 44);  -- sfix6 [45]
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      HwModeRegister_reg <= (OTHERS => to_signed(16#000000#, 23));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        HwModeRegister_reg(0) <= gradientIn_signed;
        HwModeRegister_reg(1) <= HwModeRegister_reg(0);
      END IF;
    END IF;
  END PROCESS HwModeRegister_process;

  Delay3_out1 <= HwModeRegister_reg(1);
  ...
  LUT_k <= to_unsigned(16#00#, 6) WHEN HDL_Counter_out1 = to_unsigned(16#00#, 6) ELSE
      to_unsigned(16#33#, 6) WHEN HDL_Counter_out1 >= to_unsigned(16#33#, 6) ELSE
      HDL_Counter_out1;
  ...
  BEGIN
    IF reset = '1' THEN
      HwModeRegister1_reg <= (OTHERS => to_signed(16#00#, 6));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        HwModeRegister1_reg(0) <= LUT_out1_1;
        HwModeRegister1_reg(1 TO 44) <= HwModeRegister1_reg(0 TO 43);
      END IF;
    END IF;
  END PROCESS HwModeRegister1_process;

  LUT_out1_2 <= HwModeRegister1_reg(44);

  Product_mul_temp <= Delay3_out1 * LUT_out1_2;
  ...
  PhaseOut <= std_logic_vector(Product_out1_1);
