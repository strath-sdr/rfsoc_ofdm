-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_Cell0_block.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_2/CordicRotate/Cell0
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_Cell0_block IS
  ...
  SIGNAL delayMatch1_reg                  : vector_of_signed21(0 TO 1);  -- sfix21 [2]
  SIGNAL Add1_out1_1                      : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL Add4_out1                        : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL delayMatch_reg                   : vector_of_signed21(0 TO 1);  -- sfix21 [2]
  ...
  SIGNAL delayMatch3_reg                  : vector_of_signed21(0 TO 1);  -- sfix21 [2]
  SIGNAL Add3_out1_1                      : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL Add2_out1                        : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL delayMatch2_reg                  : vector_of_signed21(0 TO 1);  -- sfix21 [2]
