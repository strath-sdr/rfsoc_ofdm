-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_Quadrant_Mapper.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_1/GradientEstimate /Complex to Magnitude-Angle HDL Optimized/Quadrant_Mapper
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_Quadrant_Mapper IS
  ...
  SIGNAL abs_y_1                          : signed(19 DOWNTO 0);  -- sfix20_En15
  SIGNAL abs_cast_1                       : signed(19 DOWNTO 0);  -- sfix20_En15
