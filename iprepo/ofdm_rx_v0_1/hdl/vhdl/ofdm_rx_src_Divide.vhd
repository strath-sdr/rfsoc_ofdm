-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_Divide.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/ChannelEstEq/Equalise/Divide
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_Divide IS
  ...
  SIGNAL HwModeRegister_reg               : vector_of_signed18(0 TO 38);  -- sfix18 [39]
  ...
  SIGNAL HwModeRegister2_reg              : vector_of_signed18(0 TO 38);  -- sfix18 [39]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Delay8_out1_re <= In1_re_signed;
        Delay8_out1_im <= In1_im_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        HwModeRegister_reg(0) <= Delay8_out1_re;
        HwModeRegister_reg(1 TO 38) <= HwModeRegister_reg(0 TO 37);
      END IF;
    END IF;
  END PROCESS HwModeRegister_process;

  Product2_C2ReIm_C2ReIm_A <= HwModeRegister_reg(38);
  ...
  BEGIN
    IF reset = '1' THEN
      Reciprocal_out1_1 <= to_unsigned(16#0000000#, 25);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        Reciprocal_out1_1 <= Reciprocal_out1_unsigned;
      END IF;
    END IF;
  END PROCESS reduced_process;


  Product2_cast <= signed(resize(Reciprocal_out1_1, 26));
  ...
  dataOutEq_re <= std_logic_vector(Product2_Re_1);

  HwModeRegister2_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      HwModeRegister2_reg <= (OTHERS => to_signed(16#00000#, 18));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        HwModeRegister2_reg(0) <= Delay8_out1_im;
        HwModeRegister2_reg(1 TO 38) <= HwModeRegister2_reg(0 TO 37);
      END IF;
    END IF;
  END PROCESS HwModeRegister2_process;

  Product2_C2ReIm_C2ReIm_B <= HwModeRegister2_reg(38);

  Product21_cast <= signed(resize(Reciprocal_out1_1, 26));
  ...
  dataOutEq_im <= std_logic_vector(Product2_Im_1);
