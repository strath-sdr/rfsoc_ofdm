-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_MagPhase.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/SchmidlCoxMetric /MagPhase
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_MagPhase IS
  ...
  COMPONENT ofdm_rx_src_Complex_to_Magnitude_Angle_HDL_Optimized_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_192_0                     :   IN    std_logic;
  ...
  FOR ALL : ofdm_rx_src_Complex_to_Magnitude_Angle_HDL_Optimized_block
    USE ENTITY work.ofdm_rx_src_Complex_to_Magnitude_Angle_HDL_Optimized_block(rtl);
...
BEGIN
  u_Complex_to_Magnitude_Angle_HDL_Optimized : ofdm_rx_src_Complex_to_Magnitude_Angle_HDL_Optimized_block
    PORT MAP( clk => clk,
              reset => reset,
