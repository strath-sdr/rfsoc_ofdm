-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_ChannelEstimate.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/ChannelEstEq/ChannelEstimate
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_rx_src_ChannelEstimate IS
  ...
  SIGNAL WriteEnbAddrGen_out1_unsigned    : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL delayMatch_reg                   : vector_of_unsigned6(0 TO 1);  -- ufix6 [2]
  SIGNAL WriteEnbAddrGen_out1_1           : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL delayMatch1_reg                  : std_logic_vector(0 TO 1);  -- ufix1 [2]
  SIGNAL WriteEnbAddrGen_out2_1           : std_logic;
  SIGNAL Delay1_reg                       : std_logic_vector(0 TO 4);  -- ufix1 [5]
  SIGNAL Delay1_out1                      : std_logic;
  SIGNAL HDL_Counter3_out1                : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL delayMatch2_reg                  : vector_of_unsigned6(0 TO 1);  -- ufix6 [2]
  SIGNAL HDL_Counter3_out1_1              : unsigned(5 DOWNTO 0);  -- ufix6
...
BEGIN
  ...
  u_Dual_Port_RAM1 : ofdm_rx_src_DualPortRAM_generic
    ...
    PORT MAP( clk => clk,
              ...
              wr_addr => std_logic_vector(WriteEnbAddrGen_out1_1),
              wr_en => WriteEnbAddrGen_out2_1,
              rd_addr => std_logic_vector(HDL_Counter3_out1_1),
  ...
  WriteEnbAddrGen_out1_unsigned <= unsigned(WriteEnbAddrGen_out1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        delayMatch_reg(0) <= WriteEnbAddrGen_out1_unsigned;
        delayMatch_reg(1) <= delayMatch_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch_process;

  WriteEnbAddrGen_out1_1 <= delayMatch_reg(1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        delayMatch1_reg(0) <= WriteEnbAddrGen_out2;
        delayMatch1_reg(1) <= delayMatch1_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch1_process;

  WriteEnbAddrGen_out2_1 <= delayMatch1_reg(1);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' AND Delay1_out1 = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      delayMatch2_reg <= (OTHERS => to_unsigned(16#00#, 6));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
        delayMatch2_reg(0) <= HDL_Counter3_out1;
        delayMatch2_reg(1) <= delayMatch2_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch2_process;

  HDL_Counter3_out1_1 <= delayMatch2_reg(1);
