...
BEGIN
  ...
  Multiport_Switch_out1_re <= BPSKmap_out1_re_signed WHEN modScheme_unsigned = to_unsigned(0, 32) ELSE
      QPSKMap_out1_re_signed WHEN modScheme_unsigned = to_unsigned(1, 32) ELSE
      alpha16QAMMap_out1_re_signed;
  
  Multiport_Switch_out1_im <= BPSKmap_out1_im_signed WHEN modScheme_unsigned = to_unsigned(0, 32) ELSE
      QPSKMap_out1_im_signed WHEN modScheme_unsigned = to_unsigned(1, 32) ELSE
