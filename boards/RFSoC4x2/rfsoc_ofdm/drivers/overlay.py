...
class Overlay(Overlay):
    ...
    def configure_clocks(self, lmk_freq=245.76, lmx_freq=384.00):
        """
        """
    ...
    def configure_adcs(self, pll_freq=384.00, sample_freq=3840.00, nyquist_zone=1, centre_freq=-600):
        ...
        self.adc_tile.ShutDown() # Do some power cycling
        sleep(1) # Do some power cycling
        self.adc_tile.StartUp() # Do some power cycling
    ...
    def configure_dacs(self, pll_freq=384.00, sample_freq=3840.00, nyquist_zone=1, centre_freq=600):
        ...
        self.dac_tile.ShutDown() # Do some power cycling
        sleep(1) # Do some power cycling
        self.dac_tile.StartUp() # Do some power cycling
