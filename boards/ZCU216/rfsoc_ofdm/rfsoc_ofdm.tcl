...
################################################################
# This is a generated script based on design: rfsoc_ofdm
#
...
strathsdr.org:PYNQ-SDR:ofdm_decimator:1.0\
strathsdr.org:PYNQ-SDR:ofdm_interpolator:1.0\
...
strathsdr.org:PYNQ-SDR:axis_packet_controller:1.0\
...
# Hierarchical cell: InspectorTransmitter
proc create_hier_cell_InspectorTransmitter { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_InspectorTransmitter() - Empty argument(s)!"}
     return
  }
  ...
  set data_inspector_module [ create_bd_cell -type ip -vlnv strathsdr.org:PYNQ-SDR:axis_packet_controller:1.0 data_inspector_module ]
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins S00_AXIS] [get_bd_intf_pins axis_switch/S00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_switch_M00_AXIS [get_bd_intf_pins axis_switch/M00_AXIS] [get_bd_intf_pins data_inspector_module/S_AXIS]
  ...
  connect_bd_intf_net -intf_net s_axi_interconnect_M01_AXI [get_bd_intf_pins data_inspector_module/S_AXI_Lite] [get_bd_intf_pins s_axi_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net s_axi_interconnect_M02_AXI [get_bd_intf_pins axis_switch/S_AXI_CTRL] [get_bd_intf_pins s_axi_interconnect/M02_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_s2mm_introut1 [get_bd_pins irq] [get_bd_pins axi_dma/s2mm_introut]
  connect_bd_net -net proc_sys_reset_clk_dac1_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axis_switch/aresetn] [get_bd_pins axis_switch/s_axi_ctrl_aresetn] [get_bd_pins data_inspector_module/aresetn] [get_bd_pins s_axi_interconnect/ARESETN] [get_bd_pins s_axi_interconnect/M00_ARESETN] [get_bd_pins s_axi_interconnect/M01_ARESETN] [get_bd_pins s_axi_interconnect/M02_ARESETN] [get_bd_pins s_axi_interconnect/S00_ARESETN]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axis_switch/aclk] [get_bd_pins axis_switch/s_axi_ctrl_aclk] [get_bd_pins data_inspector_module/aclk] [get_bd_pins s_axi_interconnect/ACLK] [get_bd_pins s_axi_interconnect/M00_ACLK] [get_bd_pins s_axi_interconnect/M01_ACLK] [get_bd_pins s_axi_interconnect/M02_ACLK] [get_bd_pins s_axi_interconnect/S00_ACLK]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: InspectorReceiver
proc create_hier_cell_InspectorReceiver { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_InspectorReceiver() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins S00_AXIS] [get_bd_intf_pins axis_switch/S00_AXIS]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_dma/S_AXI_LITE] [get_bd_intf_pins s_axi_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net axis_packet_controller_M_AXIS [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins data_inspector_module/M_AXIS]
  connect_bd_intf_net -intf_net axis_switch_M00_AXIS [get_bd_intf_pins axis_switch/M00_AXIS] [get_bd_intf_pins data_inspector_module/S_AXIS]
  connect_bd_intf_net -intf_net s_axi_interconnect_M01_AXI [get_bd_intf_pins data_inspector_module/S_AXI_Lite] [get_bd_intf_pins s_axi_interconnect/M01_AXI]
  connect_bd_intf_net -intf_net s_axi_interconnect_M02_AXI [get_bd_intf_pins axis_switch/S_AXI_CTRL] [get_bd_intf_pins s_axi_interconnect/M02_AXI]
...
# Hierarchical cell: InspectorConstellation
proc create_hier_cell_InspectorConstellation { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_InspectorConstellation() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_dma/S_AXI_LITE] [get_bd_intf_pins s_axi_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net axis_packet_controll_0_M_AXIS [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins data_inspector_module/M_AXIS]
  connect_bd_intf_net -intf_net s_axi_interconnect_M01_AXI [get_bd_intf_pins data_inspector_module/S_AXI_Lite] [get_bd_intf_pins s_axi_interconnect/M01_AXI]

  # Create port connections
  connect_bd_net -net axi_dma_s2mm_introut1 [get_bd_pins irq] [get_bd_pins axi_dma/s2mm_introut]
  connect_bd_net -net proc_sys_reset_clk_dac1_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins data_inspector_module/aresetn] [get_bd_pins s_axi_interconnect/ARESETN] [get_bd_pins s_axi_interconnect/M00_ARESETN] [get_bd_pins s_axi_interconnect/M01_ARESETN] [get_bd_pins s_axi_interconnect/S00_ARESETN]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins data_inspector_module/aclk] [get_bd_pins s_axi_interconnect/ACLK] [get_bd_pins s_axi_interconnect/M00_ACLK] [get_bd_pins s_axi_interconnect/M01_ACLK] [get_bd_pins s_axi_interconnect/S00_ACLK]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: InspectorConstellation
  create_hier_cell_InspectorConstellation [current_bd_instance .] InspectorConstellation

  # Create instance: InspectorReceiver
  create_hier_cell_InspectorReceiver [current_bd_instance .] InspectorReceiver

  # Create instance: InspectorTransmitter
  create_hier_cell_InspectorTransmitter [current_bd_instance .] InspectorTransmitter
  ...
  set_property -dict [ list \
   CONFIG.M00_TDATA_REMAP {tdata[47:32], tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[63:48], tdata[31:16]} \
   CONFIG.M_TDATA_NUM_BYTES {4} \
   CONFIG.S_TDATA_NUM_BYTES {8} \
 ] $axis_broadcaster

  # Create instance: ofdm_decimator, and set properties
  set ofdm_decimator [ create_bd_cell -type ip -vlnv strathsdr.org:PYNQ-SDR:ofdm_decimator:1.0 ofdm_decimator ]

  # Create instance: ofdm_interpolator, and set properties
  set ofdm_interpolator [ create_bd_cell -type ip -vlnv strathsdr.org:PYNQ-SDR:ofdm_interpolator:1.0 ofdm_interpolator ]

  # Create instance: ofdm_receiver, and set properties
  set ofdm_receiver [ create_bd_cell -type ip -vlnv xilinx.com:ip:ofdm_rx:0.4 ofdm_receiver ]

  # Create instance: ofdm_transmitter, and set properties
  set ofdm_transmitter [ create_bd_cell -type ip -vlnv xilinx.com:ip:ofdm_tx:0.4 ofdm_transmitter ]

  # Create instance: proc_sys_reset_clk_adc_1, and set properties
  set proc_sys_reset_clk_adc_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_clk_adc_1 ]

  # Create instance: proc_sys_reset_clk_dac_1, and set properties
  set proc_sys_reset_clk_dac_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_clk_dac_1 ]

  # Create instance: proc_sys_reset_clk_dac_2, and set properties
  set proc_sys_reset_clk_dac_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_clk_dac_2 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC1_Fabric_Freq {240.000} \
   CONFIG.ADC1_Outclk_Freq {240.000} \
   CONFIG.ADC1_PLL_Enable {true} \
   CONFIG.ADC1_Refclk_Freq {384.000} \
   CONFIG.ADC1_Sampling_Rate {1.92} \
   ...
   CONFIG.DAC1_Fabric_Freq {240.000} \
   CONFIG.DAC1_Outclk_Freq {240.000} \
   CONFIG.DAC1_PLL_Enable {true} \
   CONFIG.DAC1_Refclk_Freq {384.000} \
   CONFIG.DAC1_Sampling_Rate {3.84} \
   CONFIG.DAC2_Clock_Source {5} \
   CONFIG.DAC2_Enable {1} \
   CONFIG.DAC2_Fabric_Freq {240.000} \
   CONFIG.DAC2_Outclk_Freq {240.000} \
   CONFIG.DAC2_PLL_Enable {true} \
   CONFIG.DAC2_Refclk_Freq {384.000} \
   CONFIG.DAC2_Sampling_Rate {3.84} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DataInspectorObserve_M_AXI [get_bd_intf_pins InspectorTransmitter/M_AXI] [get_bd_intf_pins axi_interconnect_hp2/S00_AXI]
  connect_bd_intf_net -intf_net InspectorReceiver_M_AXI [get_bd_intf_pins InspectorReceiver/M_AXI] [get_bd_intf_pins axi_interconnect_hp0/S01_AXI]
  connect_bd_intf_net -intf_net S00_AXIS_1 [get_bd_intf_pins InspectorTransmitter/S00_AXIS] [get_bd_intf_pins ofdm_interpolator/M_SYMBOL_AXIS]
  connect_bd_intf_net -intf_net S00_AXIS_2 [get_bd_intf_pins InspectorReceiver/S00_AXIS] [get_bd_intf_pins ofdm_decimator/M_SYMBOL_AXIS]
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins InspectorConstellation/M_AXI] [get_bd_intf_pins axi_interconnect_hp0/S00_AXI]
  connect_bd_intf_net -intf_net S_AXIS_3 [get_bd_intf_pins InspectorConstellation/S_AXIS] [get_bd_intf_pins ofdm_receiver/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins InspectorReceiver/S_AXI] [get_bd_intf_pins ps8_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net S_AXI_2 [get_bd_intf_pins InspectorTransmitter/S_AXI] [get_bd_intf_pins ps8_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net S_AXI_3 [get_bd_intf_pins InspectorConstellation/S_AXI] [get_bd_intf_pins ps8_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net adc1_clk_1 [get_bd_intf_ports adc1_clk] [get_bd_intf_pins rfdc/adc1_clk]
  connect_bd_intf_net -intf_net axi_interconnect_hp0_M00_AXI [get_bd_intf_pins axi_interconnect_hp0/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_interconnect_hp2_M00_AXI [get_bd_intf_pins axi_interconnect_hp2/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster/M00_AXIS] [get_bd_intf_pins ofdm_decimator/S_REAL_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster/M01_AXIS] [get_bd_intf_pins ofdm_decimator/S_IMAG_AXIS]
  connect_bd_intf_net -intf_net dac1_clk_1 [get_bd_intf_ports dac1_clk] [get_bd_intf_pins rfdc/dac1_clk]
  connect_bd_intf_net -intf_net ofdm_decimator_M_AXIS [get_bd_intf_pins ofdm_decimator/M_AXIS] [get_bd_intf_pins ofdm_receiver/AXI4_Stream_Slave]
  connect_bd_intf_net -intf_net ofdm_decimator_M_OBSERVE_AXIS [get_bd_intf_pins InspectorReceiver/S01_AXIS] [get_bd_intf_pins ofdm_decimator/M_OBSERVE_AXIS]
  connect_bd_intf_net -intf_net ofdm_interpolator_M_AXIS [get_bd_intf_pins ofdm_interpolator/M_AXIS] [get_bd_intf_pins rfdc/s20_axis]
  connect_bd_intf_net -intf_net ofdm_interpolator_M_OBSERVE_AXIS [get_bd_intf_pins InspectorTransmitter/S01_AXIS] [get_bd_intf_pins ofdm_interpolator/M_OBSERVE_AXIS]
  connect_bd_intf_net -intf_net ofdm_transmitter_AXI4_Stream_Master [get_bd_intf_pins ofdm_interpolator/S_AXIS] [get_bd_intf_pins ofdm_transmitter/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net ps8_axi_periph_M00_AXI [get_bd_intf_pins ps8_axi_periph/M00_AXI] [get_bd_intf_pins rfdc/s_axi]
  connect_bd_intf_net -intf_net ps8_axi_periph_M01_AXI [get_bd_intf_pins ofdm_transmitter/AXI4_Lite] [get_bd_intf_pins ps8_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_axi_periph_M02_AXI [get_bd_intf_pins ofdm_receiver/AXI4_Lite] [get_bd_intf_pins ps8_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_axi_periph_M06_AXI [get_bd_intf_pins axi_intc/s_axi] [get_bd_intf_pins ps8_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net sysref_in_1 [get_bd_intf_ports sysref_in] [get_bd_intf_pins rfdc/sysref_in]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m10_axis [get_bd_intf_pins axis_broadcaster/S_AXIS] [get_bd_intf_pins rfdc/m10_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout10 [get_bd_intf_ports vout10] [get_bd_intf_pins rfdc/vout10]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_vout20 [get_bd_intf_ports vout20] [get_bd_intf_pins rfdc/vout20]
  connect_bd_intf_net -intf_net vin10_1 [get_bd_intf_ports vin10] [get_bd_intf_pins rfdc/vin10]
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_hp2/ARESETN] [get_bd_pins proc_sys_reset_clk_dac_2/interconnect_aresetn]
  connect_bd_net -net ARESETN_2 [get_bd_pins axi_interconnect_hp0/ARESETN] [get_bd_pins proc_sys_reset_clk_adc_1/interconnect_aresetn]
  connect_bd_net -net DataInspectorObserve_irq [get_bd_pins InspectorTransmitter/irq] [get_bd_pins xlconcat/In2]
  connect_bd_net -net DataInspectorReceive_irq [get_bd_pins InspectorConstellation/irq] [get_bd_pins xlconcat/In0]
  connect_bd_net -net InspectorReceiver_irq [get_bd_pins InspectorReceiver/irq] [get_bd_pins xlconcat/In1]
  connect_bd_net -net axi_intc_irq [get_bd_pins axi_intc/irq] [get_bd_pins zynq_ultra_ps_e/pl_ps_irq0]
  connect_bd_net -net proc_sys_reset_clk_adc_2_peripheral_aresetn [get_bd_pins InspectorConstellation/aresetn] [get_bd_pins InspectorReceiver/aresetn] [get_bd_pins axi_interconnect_hp0/M00_ARESETN] [get_bd_pins axi_interconnect_hp0/S00_ARESETN] [get_bd_pins axi_interconnect_hp0/S01_ARESETN] [get_bd_pins axis_broadcaster/aresetn] [get_bd_pins ofdm_decimator/aresetn] [get_bd_pins ofdm_receiver/AXI4_Lite_ARESETN] [get_bd_pins ofdm_receiver/IPCORE_RESETN] [get_bd_pins proc_sys_reset_clk_adc_1/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M02_ARESETN] [get_bd_pins ps8_axi_periph/M03_ARESETN] [get_bd_pins ps8_axi_periph/M04_ARESETN] [get_bd_pins rfdc/m1_axis_aresetn]
  connect_bd_net -net proc_sys_reset_clk_dac_1_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac_1/peripheral_aresetn] [get_bd_pins rfdc/s1_axis_aresetn]
  connect_bd_net -net proc_sys_reset_clk_dac_2_peripheral_aresetn [get_bd_pins InspectorTransmitter/aresetn] [get_bd_pins axi_interconnect_hp2/M00_ARESETN] [get_bd_pins axi_interconnect_hp2/S00_ARESETN] [get_bd_pins ofdm_interpolator/aresetn] [get_bd_pins ofdm_transmitter/AXI4_Lite_ARESETN] [get_bd_pins ofdm_transmitter/IPCORE_RESETN] [get_bd_pins proc_sys_reset_clk_dac_2/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M01_ARESETN] [get_bd_pins ps8_axi_periph/M05_ARESETN] [get_bd_pins rfdc/s2_axis_aresetn]
  connect_bd_net -net rfdc_clk_adc2 [get_bd_pins InspectorConstellation/aclk] [get_bd_pins InspectorReceiver/aclk] [get_bd_pins axi_interconnect_hp0/ACLK] [get_bd_pins axi_interconnect_hp0/M00_ACLK] [get_bd_pins axi_interconnect_hp0/S00_ACLK] [get_bd_pins axi_interconnect_hp0/S01_ACLK] [get_bd_pins axis_broadcaster/aclk] [get_bd_pins ofdm_decimator/aclk] [get_bd_pins ofdm_receiver/AXI4_Lite_ACLK] [get_bd_pins ofdm_receiver/IPCORE_CLK] [get_bd_pins proc_sys_reset_clk_adc_1/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M02_ACLK] [get_bd_pins ps8_axi_periph/M03_ACLK] [get_bd_pins ps8_axi_periph/M04_ACLK] [get_bd_pins rfdc/clk_adc1] [get_bd_pins rfdc/m1_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  connect_bd_net -net rfdc_clk_dac3 [get_bd_pins InspectorTransmitter/aclk] [get_bd_pins axi_interconnect_hp2/ACLK] [get_bd_pins axi_interconnect_hp2/M00_ACLK] [get_bd_pins axi_interconnect_hp2/S00_ACLK] [get_bd_pins ofdm_interpolator/aclk] [get_bd_pins ofdm_transmitter/AXI4_Lite_ACLK] [get_bd_pins ofdm_transmitter/IPCORE_CLK] [get_bd_pins proc_sys_reset_clk_dac_2/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M05_ACLK] [get_bd_pins rfdc/clk_dac2] [get_bd_pins rfdc/s2_axis_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  connect_bd_net -net rst_ps8_99M_peripheral_aresetn [get_bd_pins axi_intc/s_axi_aresetn] [get_bd_pins ps8_axi_periph/ARESETN] [get_bd_pins ps8_axi_periph/M00_ARESETN] [get_bd_pins ps8_axi_periph/M06_ARESETN] [get_bd_pins ps8_axi_periph/S00_ARESETN] [get_bd_pins rfdc/s_axi_aresetn] [get_bd_pins rst_ps8_99M/peripheral_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins proc_sys_reset_clk_dac_1/slowest_sync_clk] [get_bd_pins rfdc/clk_dac1] [get_bd_pins rfdc/s1_axis_aclk]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc/intr] [get_bd_pins xlconcat/dout]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins axi_intc/s_axi_aclk] [get_bd_pins ps8_axi_periph/ACLK] [get_bd_pins ps8_axi_periph/M00_ACLK] [get_bd_pins ps8_axi_periph/M06_ACLK] [get_bd_pins ps8_axi_periph/S00_ACLK] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins rst_ps8_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins proc_sys_reset_clk_adc_1/ext_reset_in] [get_bd_pins proc_sys_reset_clk_dac_1/ext_reset_in] [get_bd_pins proc_sys_reset_clk_dac_2/ext_reset_in] [get_bd_pins rst_ps8_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorTransmitter/axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorConstellation/axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorReceiver/axi_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_intc/S_AXI/Reg] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorReceiver/axis_switch/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorTransmitter/axis_switch/S_AXI_CTRL/Reg] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorConstellation/data_inspector_module/S_AXI_Lite/S_AXI_Lite_reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorReceiver/data_inspector_module/S_AXI_Lite/S_AXI_Lite_reg] -force
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs InspectorTransmitter/data_inspector_module/S_AXI_Lite/S_AXI_Lite_reg] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs ofdm_receiver/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs ofdm_transmitter/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs rfdc/s_axi/Reg] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces InspectorConstellation/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces InspectorConstellation/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces InspectorConstellation/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces InspectorReceiver/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces InspectorReceiver/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces InspectorReceiver/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces InspectorTransmitter/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces InspectorTransmitter/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces InspectorTransmitter/axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM] -force
