...
#define  IPCore_Timestamp_ofdm_rx                       0xC  //contains unique IP timestamp (yymmddHHMM): 2105061202
...
#define  select_Data_ofdm_rx                            0x108  //data register for Inport select
