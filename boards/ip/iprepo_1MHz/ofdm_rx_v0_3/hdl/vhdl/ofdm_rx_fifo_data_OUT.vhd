-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Rx_HW\ofdm_rx_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_fifo_data_OUT
-- Source Path: ofdm_rx/ofdm_rx_axi4_stream_master/ofdm_rx_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_fifo_data_OUT IS
...
END ofdm_rx_fifo_data_OUT;


ARCHITECTURE rtl OF ofdm_rx_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT ofdm_rx_SimpleDualPortRAM_generic
  ...
  FOR ALL : ofdm_rx_SimpleDualPortRAM_generic
    USE ENTITY work.ofdm_rx_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_ofdm_rx_fifo_data_OUT_classic_ram_generic : ofdm_rx_SimpleDualPortRAM_generic
