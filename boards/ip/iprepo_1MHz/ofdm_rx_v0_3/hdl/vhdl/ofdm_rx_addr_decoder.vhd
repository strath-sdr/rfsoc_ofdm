...
ARCHITECTURE rtl OF ofdm_rx_addr_decoder IS
  ...
  SIGNAL decode_sel_select_1_1            : std_logic;  -- ufix1
  ...
  SIGNAL reg_enb_select_1_1               : std_logic;  -- ufix1
  SIGNAL data_reg_select_1_1              : unsigned(31 DOWNTO 0);  -- ufix32
  SIGNAL decode_rd_select_1_1             : unsigned(31 DOWNTO 0);  -- ufix32

BEGIN
  addr_sel_unsigned <= unsigned(addr_sel);

  
  decode_sel_select_1_1 <= '1' WHEN addr_sel_unsigned = to_unsigned(16#0042#, 14) ELSE
      '0';
  ...
  reg_enb_select_1_1 <= decode_sel_select_1_1 AND wr_enb;

  reg_select_1_1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      data_reg_select_1_1 <= to_unsigned(0, 32);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' AND reg_enb_select_1_1 = '1' THEN
        data_reg_select_1_1 <= data_write_unsigned;
      END IF;
    END IF;
  END PROCESS reg_select_1_1_process;


  
  decode_rd_select_1_1 <= decode_rd_enable_threshold_1_1 WHEN decode_sel_select_1_1 = '0' ELSE
      data_reg_select_1_1;

  data_read <= std_logic_vector(decode_rd_select_1_1);
  ...
  write_select <= std_logic_vector(data_reg_select_1_1);
