...
BEGIN
  ...
  Data_Type_Conversion_out1 <= threshold_1;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_1 = '1' THEN
        Delay3_bypass_reg <= ThreshMult_out1_signed;
      END IF;
    END IF;
  END PROCESS Delay3_bypass_process;

  
  ThreshMult_out1_1 <= ThreshMult_out1_signed WHEN enb_1_256_1 = '1' ELSE
      Delay3_bypass_reg;

  right <= std_logic_vector(ThreshMult_out1_1);
