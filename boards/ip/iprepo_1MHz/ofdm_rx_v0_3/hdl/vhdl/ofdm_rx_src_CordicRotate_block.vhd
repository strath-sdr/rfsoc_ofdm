...
ARCHITECTURE rtl OF ofdm_rx_src_CordicRotate_block IS
  ...
  SIGNAL delayMatch37_reg                 : vector_of_signed21(0 TO 1);  -- sfix21 [2]
  SIGNAL Data_Type_Conversion8_out1_1     : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL delayMatch38_reg                 : vector_of_signed21(0 TO 1);  -- sfix21 [2]
  ...
  SIGNAL xout_1                           : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL Delay46_out1                     : std_logic_vector(20 DOWNTO 0);  -- ufix21
  ...
  SIGNAL yout_1                           : signed(20 DOWNTO 0);  -- sfix21_En15
  SIGNAL Delay49_out1                     : std_logic_vector(20 DOWNTO 0);  -- ufix21
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      delayMatch37_reg <= (OTHERS => to_signed(16#000000#, 21));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' THEN
        delayMatch37_reg(0) <= Data_Type_Conversion8_out1;
        delayMatch37_reg(1) <= delayMatch37_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch37_process;

  Data_Type_Conversion8_out1_1 <= delayMatch37_reg(1);

  delayMatch38_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      delayMatch38_reg <= (OTHERS => to_signed(16#000000#, 21));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' THEN
        delayMatch38_reg(0) <= Data_Type_Conversion9_out1;
        delayMatch38_reg(1) <= delayMatch38_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch38_process;

  Data_Type_Conversion9_out1_1 <= delayMatch38_reg(1);
  ...
  Delay46_out1 <= std_logic_vector(xout_1);
  ...
  GAIN_CORR_out1_1 <= GAIN_CORR_out1_signed WHEN enb_1_256_1 = '1' ELSE
      Delay86_bypass_reg;
  ...
  Delay49_out1 <= std_logic_vector(yout_1);
  ...
  GAIN_CORR1_out1_1 <= GAIN_CORR1_out1_signed WHEN enb_1_256_1 = '1' ELSE
      Delay42_bypass_reg;
