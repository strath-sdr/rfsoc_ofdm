...
ARCHITECTURE rtl OF ofdm_rx_src_DataArrange IS
  ...
  SIGNAL Dual_Port_RAM3_bypass_reg        : std_logic;  -- ufix1
  SIGNAL dataValidIn_5                    : std_logic;
  SIGNAL Dual_Port_RAM1_bypass_reg        : unsigned(6 DOWNTO 0);  -- ufix7
...
BEGIN
  ...
  dataValidIn_3 <= dataValidIn_2 WHEN enb_1_256_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' AND dataValidIn_3 = '1' THEN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' AND Delay_out1 = '1' THEN
  ...
  Dual_Port_RAM3_bypass_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Dual_Port_RAM3_bypass_reg <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_1 = '1' THEN
        Dual_Port_RAM3_bypass_reg <= dataValidIn_2;
      END IF;
    END IF;
  END PROCESS Dual_Port_RAM3_bypass_process;

  
  dataValidIn_5 <= dataValidIn_2 WHEN enb_1_256_1 = '1' ELSE
      Dual_Port_RAM3_bypass_reg;

  Dual_Port_RAM1_bypass_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      Dual_Port_RAM1_bypass_reg <= to_unsigned(16#00#, 7);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_1 = '1' THEN
  ...
  READ_CTRL_out1_1 <= READ_CTRL_out1_unsigned WHEN enb_1_256_1 = '1' ELSE
  ...
  Dual_Port_RAM_out2_re_3 <= Dual_Port_RAM_out2_re_2 WHEN enb_1_256_1 = '1' ELSE
      Delay10_bypass_reg_re;
  
  Dual_Port_RAM_out2_im_3 <= Dual_Port_RAM_out2_im_2 WHEN enb_1_256_1 = '1' ELSE
