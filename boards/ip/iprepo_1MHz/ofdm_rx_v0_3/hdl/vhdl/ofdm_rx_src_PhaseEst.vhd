...
ARCHITECTURE rtl OF ofdm_rx_src_PhaseEst IS
  ...
  SIGNAL reduced_reg_re                   : vector_of_signed18(0 TO 14);  -- sfix18_En15 [15]
  SIGNAL reduced_reg_im                   : vector_of_signed18(0 TO 14);  -- sfix18_En15 [15]
...
BEGIN
  ...
  dataIn_re_2 <= reduced_reg_re(14);
  dataIn_im_2 <= reduced_reg_im(14);
  ...
  Delay2_out1_re <= dataIn_re_1;

  Delay3_out1_re <= signed(PilotIn_re);
  ...
  Delay2_out1_im <= dataIn_im_1;

  Delay3_out1_im <= signed(PilotIn_im);
