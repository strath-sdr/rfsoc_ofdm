...
ARCHITECTURE rtl OF ofdm_rx_src_CordicRotate IS
  ...
  SIGNAL delayMatch39_reg                 : vector_of_signed21(0 TO 1);  -- sfix21 [2]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' THEN
        delayMatch38_reg(0) <= Data_Type_Conversion8_out1;
        delayMatch38_reg(1) <= delayMatch38_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch38_process;

  Data_Type_Conversion8_out1_1 <= delayMatch38_reg(1);

  delayMatch39_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      delayMatch39_reg <= (OTHERS => to_signed(16#000000#, 21));
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' THEN
        delayMatch39_reg(0) <= Data_Type_Conversion9_out1;
        delayMatch39_reg(1) <= delayMatch39_reg(0);
      END IF;
    END IF;
  END PROCESS delayMatch39_process;

  Data_Type_Conversion9_out1_1 <= delayMatch39_reg(1);
  ...
  Gain1_out1_2 <= Gain1_out1_1 WHEN enb_1_256_1 = '1' ELSE
      Delay1_bypass_reg;
