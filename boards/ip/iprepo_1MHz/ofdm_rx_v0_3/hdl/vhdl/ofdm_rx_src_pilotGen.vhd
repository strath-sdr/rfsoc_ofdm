-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_pilotGen.vhd
...
BEGIN
  ...
  Logical_Operator3_out1_1 <= Logical_Operator3_out1 WHEN enb_1_256_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' AND Logical_Operator3_out1_1 = '1' THEN
