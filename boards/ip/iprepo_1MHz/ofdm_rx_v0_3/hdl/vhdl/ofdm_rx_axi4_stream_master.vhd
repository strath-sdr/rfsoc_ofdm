-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Rx_HW\ofdm_rx_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_axi4_stream_master
-- Source Path: ofdm_rx/ofdm_rx_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_axi4_stream_master IS
...
END ofdm_rx_axi4_stream_master;


ARCHITECTURE rtl OF ofdm_rx_axi4_stream_master IS

  -- Component Declarations
  COMPONENT ofdm_rx_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT ofdm_rx_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : ofdm_rx_fifo_data_OUT
    USE ENTITY work.ofdm_rx_fifo_data_OUT(rtl);

  FOR ALL : ofdm_rx_fifo_TLAST_OUT
    USE ENTITY work.ofdm_rx_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_ofdm_rx_fifo_data_OUT_inst : ofdm_rx_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ofdm_rx_fifo_TLAST_OUT_inst : ofdm_rx_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
