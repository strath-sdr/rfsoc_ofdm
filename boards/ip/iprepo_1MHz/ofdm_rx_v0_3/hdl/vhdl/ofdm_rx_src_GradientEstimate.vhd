...
ARCHITECTURE rtl OF ofdm_rx_src_GradientEstimate IS
  ...
  SIGNAL Delay4_reg                       : std_logic_vector(0 TO 16);  -- ufix1 [17]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' THEN
        Delay4_reg(0) <= PilotEnd;
        Delay4_reg(1 TO 16) <= Delay4_reg(0 TO 15);
      END IF;
    END IF;
  END PROCESS Delay4_process;

  Delay4_out1 <= Delay4_reg(16);
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' THEN
        Constant_out1_3 <= Constant_out1_2;
      END IF;
    END IF;
  ...
  Unit_Delay_Enabled_Synchronous_ectrl <= Unit_Delay_Enabled_Synchronous_ectrl_2 WHEN enb_1_256_1 = '1' ELSE
