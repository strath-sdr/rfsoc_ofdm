...
ARCHITECTURE rtl OF ofdm_rx_src_PhaseErrorEst IS
  ...
  SIGNAL Delay5_bypass_reg                : signed(5 DOWNTO 0);  -- sfix6
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay5_bypass_reg <= to_signed(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_1 = '1' THEN
        Delay5_bypass_reg <= LUT_out1_1;
      END IF;
    END IF;
  END PROCESS Delay5_bypass_process;

  
  LUT_out1_2 <= LUT_out1_1 WHEN enb_1_256_1 = '1' ELSE
      Delay5_bypass_reg;

  LUT_out1_3 <= LUT_out1_2;

  HwModeRegister1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      LUT_out1_4 <= to_signed(16#00#, 6);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
  ...
  Product_mul_temp <= Delay3_out1_2 * LUT_out1_4;
