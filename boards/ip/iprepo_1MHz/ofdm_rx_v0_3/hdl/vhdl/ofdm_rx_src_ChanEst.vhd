...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' AND Delay2_out1 = '1' THEN
  ...
  InvLLTF_out1_2 <= InvLLTF_out1_1 WHEN enb_1_256_1 = '1' ELSE
      Delay5_bypass_reg;
  ...
  Product_out1_re <= Product_Re_1 WHEN enb_1_256_1 = '1' ELSE
      Delay6_bypass_reg_re;
  
  Product_out1_im <= Product_Im_1 WHEN enb_1_256_1 = '1' ELSE
