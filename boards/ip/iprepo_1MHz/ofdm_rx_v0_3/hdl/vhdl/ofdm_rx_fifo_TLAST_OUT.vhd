-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Rx_HW\ofdm_rx_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_fifo_TLAST_OUT
-- Source Path: ofdm_rx/ofdm_rx_axi4_stream_master/ofdm_rx_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_fifo_TLAST_OUT IS
...
END ofdm_rx_fifo_TLAST_OUT;


ARCHITECTURE rtl OF ofdm_rx_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT ofdm_rx_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : ofdm_rx_SimpleDualPortRAM_singlebit
    USE ENTITY work.ofdm_rx_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_ofdm_rx_fifo_TLAST_OUT_classic_ram_singlebit : ofdm_rx_SimpleDualPortRAM_singlebit
