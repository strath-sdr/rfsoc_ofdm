...
begin
  ...
  port map (
    ...
    s_axis_data_tdata_real => convert8_dout_net,
    src_clk => clk_net,
    src_ce => ce_net,
    clk => clk_net,
    ce => ce_net,
...
begin
  ...
  tdo_2 <= fir_compiler_7_2_m_axis_data_tdata_vect1_net;
  constant_op_net <= tvi;
  convert7_dout_net <= tdi;
  clk_net <= clk_1;
  ce_net <= ce_1;
  fir_compiler_7_2 : entity xil_defaultlib.xlfir_compiler_ae16df3403001533bc8ed410b9b8e120 
  port map (
    s_axis_data_tvalid => constant_op_net(0),
    s_axis_data_tdata_real => convert7_dout_net,
    src_clk => clk_net,
    src_ce => ce_net,
    clk => clk_net,
    ce => ce_net,
...
begin
  ...
  convert7_dout_net <= real_in;
  convert8_dout_net <= imag_in;
  clk_net <= clk_1;
  ce_net <= ce_1;
...
begin
  real_out <= convert7_dout_net;
  imag_out <= convert8_dout_net;
  ...
  fir_stage_3 : entity xil_defaultlib.xlfir_compiler_34589e2dff6e1bd9d02cae96d57251cd 
  port map (
  ...
  fir_stage_4 : entity xil_defaultlib.xlfir_compiler_d53bbda3cdf8e147d1d49193e80ae47b 
  port map (
    ...
    clk_16 => clk_net_x0,
    ce_16 => ce_net_x0,
    clk_logic_16 => clk_net_x0,
    ce_logic_16 => ce_net_x0,
...
begin
  ...
  port map (
    real_in => convert7_dout_net,
    imag_in => convert8_dout_net,
    clk_1 => clk_net_x2,
    ce_1 => ce_net_x2,
    real_out_1 => convert0_dout_net,
    imag_out_1 => convert0_dout_net_x0,
