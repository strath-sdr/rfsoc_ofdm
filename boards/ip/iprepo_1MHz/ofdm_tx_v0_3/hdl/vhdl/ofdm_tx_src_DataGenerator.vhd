...
ARCHITECTURE rtl OF ofdm_tx_src_DataGenerator IS
  ...
  SIGNAL delayMatch1_reg                  : std_logic_vector(0 TO 253);  -- ufix1 [254]
...
BEGIN
  ...
  modScheme_3 <= modScheme_2 WHEN enb_1_256_1 = '1' ELSE
      Delay2_bypass_reg;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        delayMatch1_reg(1 TO 253) <= delayMatch1_reg(0 TO 252);
      END IF;
    END IF;
  END PROCESS delayMatch1_process;

  pilotValid_3 <= delayMatch1_reg(253);
