...
ARCHITECTURE rtl OF ofdm_tx_src_PilotGen IS
  ...
  SIGNAL reduced_reg                      : std_logic_vector(0 TO 252);  -- ufix1 [253]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        ...
        reduced_reg(1 TO 252) <= reduced_reg(0 TO 251);
      END IF;
    END IF;
  END PROCESS reduced_1_process;

  pilotValidIn_2 <= reduced_reg(252);
  ...
  pilotValidIn_3 <= pilotValidIn_1 WHEN enb_1_256_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_256_0 = '1' AND pilotValidIn_3 = '1' THEN
