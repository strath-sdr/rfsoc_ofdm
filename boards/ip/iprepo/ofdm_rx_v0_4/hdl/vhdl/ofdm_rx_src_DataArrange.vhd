-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_DataArrange.vhd
...
BEGIN
  ...
  dataIn_re_3 <= dataIn_re_2 WHEN enb_1_384_1 = '1' ELSE
      Dual_Port_RAM2_bypass_reg_re;
  
  dataIn_im_3 <= dataIn_im_2 WHEN enb_1_384_1 = '1' ELSE
  ...
  dataValidIn_3 <= dataValidIn_2 WHEN enb_1_384_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' AND dataValidIn_3 = '1' THEN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' AND Delay_out1 = '1' THEN
  ...
  Dual_Port_RAM_out2_re_3 <= Dual_Port_RAM_out2_re_2 WHEN enb_1_384_1 = '1' ELSE
      Delay10_bypass_reg_re;
  
  Dual_Port_RAM_out2_im_3 <= Dual_Port_RAM_out2_im_2 WHEN enb_1_384_1 = '1' ELSE
