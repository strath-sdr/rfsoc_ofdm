-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_Divide.vhd
...
BEGIN
  ...
  Reciprocal_out1_1 <= Reciprocal_out1_unsigned WHEN enb_1_384_1 = '1' ELSE
      Delay1_bypass_reg;
  ...
  Product2_out1_re <= Product2_Re_1 WHEN enb_1_384_1 = '1' ELSE
      Delay2_bypass_reg_re;
  
  Product2_out1_im <= Product2_Im_1 WHEN enb_1_384_1 = '1' ELSE
