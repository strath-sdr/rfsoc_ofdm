-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_Cell7_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_Cell7_block
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_2/CordicRotate/Cell7
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_Cell7_block IS
...
END ofdm_rx_src_Cell7_block;


ARCHITECTURE rtl OF ofdm_rx_src_Cell7_block IS
...
BEGIN
  ...
  Shift_Arithmetic1_out1 <= SHIFT_RIGHT(Y_in_0_signed, 7);
  ...
  Shift_Arithmetic_out1 <= SHIFT_RIGHT(X_in_0_signed, 7);
  ...
  ANGLE_out1 <= to_signed(16#002000#, 23);
