-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_QUAD_MAP1.vhd
...
BEGIN
  ...
  lib_ofdmrx_c2_QUAD_MAP1_output : PROCESS (ctrl_unsigned, xin_signed, yin_signed)
  ...
  BEGIN
    ...
    ELSE 
      ...
      yout_tmp <= yin_signed;
    END IF;
  END PROCESS lib_ofdmrx_c2_QUAD_MAP1_output;
