-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_RADIX22FFT_SDF1_1
-- Source Path: OFDM_Rx_HW/OFDMRx/FFT/FFT HDL Optimized/RADIX22FFT_SDF1_1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_RADIX22FFT_SDF1_1 IS
...
END ofdm_rx_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF ofdm_rx_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT ofdm_rx_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : ofdm_rx_src_SDFCommutator1
    USE ENTITY work.ofdm_rx_src_SDFCommutator1(rtl);
  ...
  SIGNAL x_im_signed                      : signed(16 DOWNTO 0);  -- sfix17_En14
...
BEGIN
  u_dataMEM_im_0_1 : ofdm_rx_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_1_generic : ofdm_rx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : ofdm_rx_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
