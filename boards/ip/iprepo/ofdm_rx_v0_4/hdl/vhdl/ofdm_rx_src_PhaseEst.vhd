-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_PhaseEst.vhd
...
BEGIN
  ...
  Product_out1_re <= mulOutput WHEN enb_1_384_1 = '1' ELSE
      Delay5_bypass_reg_re;
  
  Product_out1_im <= mulOutput_1 WHEN enb_1_384_1 = '1' ELSE
