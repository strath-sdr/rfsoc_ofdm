-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_RADIX2FFT_bitNatural.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_RADIX2FFT_bitNatural
-- Source Path: OFDM_Rx_HW/OFDMRx/FFT/FFT HDL Optimized/RADIX2FFT_bitNatural
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_RADIX2FFT_bitNatural IS
...
END ofdm_rx_src_RADIX2FFT_bitNatural;


ARCHITECTURE rtl OF ofdm_rx_src_RADIX2FFT_bitNatural IS
  ...
  SIGNAL memOut_im                        : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL memOut_im_signed                 : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL memOut_re                        : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL memOut_re_signed                 : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL rdStateMachineBitNatural_doutImReg : signed(21 DOWNTO 0);  -- sfix22
  ...
  SIGNAL rdStateMachineBitNatural_doutReReg_next : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL rdStateMachineBitNatural_doutImReg_next : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL dout_re1_tmp                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL dout_im1_tmp                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL startOutW                        : std_logic;
  SIGNAL endOutW                          : std_logic;

BEGIN
  u_dataMEM_im_1 : ofdm_rx_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_1 : ofdm_rx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 22
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      rdStateMachineBitNatural_doutReReg <= to_signed(16#000000#, 22);
      rdStateMachineBitNatural_doutImReg <= to_signed(16#000000#, 22);
