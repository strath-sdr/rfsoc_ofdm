-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_QUAD_MAP1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_QUAD_MAP1_block
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_2/CordicRotate/QCORR/QUAD_MAP1
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_QUAD_MAP1_block IS
...
END ofdm_rx_src_QUAD_MAP1_block;


ARCHITECTURE rtl OF ofdm_rx_src_QUAD_MAP1_block IS
...
BEGIN
  ...
  lib_ofdmrx_c13_QUAD_MAP1_output : PROCESS (ctrl_unsigned, xin_signed, yin_signed)
  ...
  BEGIN
    ...
    ELSE 
      ...
      yout_tmp <= yin_signed;
    END IF;
  END PROCESS lib_ofdmrx_c13_QUAD_MAP1_output;
