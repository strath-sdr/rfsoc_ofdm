-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_QUAD_MAP.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_QUAD_MAP
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_1/CordicRotate/QUAD_MAP
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_QUAD_MAP IS
...
END ofdm_rx_src_QUAD_MAP;


ARCHITECTURE rtl OF ofdm_rx_src_QUAD_MAP IS

  -- Component Declarations
  COMPONENT ofdm_rx_src_QUAD_DETERM1
  ...
  FOR ALL : ofdm_rx_src_QUAD_DETERM1
    USE ENTITY work.ofdm_rx_src_QUAD_DETERM1(rtl);
...
BEGIN
  u_QUAD_DETERM1 : ofdm_rx_src_QUAD_DETERM1
