-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_CordicKernelMag_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_CordicKernelMag_block7
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_1/GradientEstimate /Complex to Magnitude-Angle HDL Optimized/CordicKernelMag
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_CordicKernelMag_block7 IS
...
END ofdm_rx_src_CordicKernelMag_block7;


ARCHITECTURE rtl OF ofdm_rx_src_CordicKernelMag_block7 IS
