-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_SDFCommutator6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_SDFCommutator6
-- Source Path: OFDM_Rx_HW/OFDMRx/FFT/FFT HDL Optimized/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_SDFCommutator6 IS
...
END ofdm_rx_src_SDFCommutator6;


ARCHITECTURE rtl OF ofdm_rx_src_SDFCommutator6 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL xf_im_signed                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL dinf_re_signed                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL dinf_im_signed                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL btf1_re_signed                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL btf1_im_signed                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL btf2_re_signed                   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL btf2_im_signed                   : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFCummutator_btf1_im_dly        : signed(21 DOWNTO 0);  -- sfix22
  SIGNAL SDFCummutator_btf1_vld_dly       : std_logic;
  SIGNAL SDFCummutator_out_re_next        : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFCummutator_out_im_next        : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL wrData_im_tmp                    : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL xData_re                         : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL xData_im                         : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL dout0_re                         : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL dout0_im                         : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL xX_re_signed                     : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL xX_im                            : std_logic_vector(21 DOWNTO 0);  -- ufix22
  SIGNAL xX_im_signed                     : signed(21 DOWNTO 0);  -- sfix22_En14
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_6_1_re_tmp                  : signed(21 DOWNTO 0);  -- sfix22_En14
  SIGNAL dout_6_1_im_tmp                  : signed(21 DOWNTO 0);  -- sfix22_En14

BEGIN
  u_dataXMEM_re_0_6 : ofdm_rx_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_6 : ofdm_rx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 22
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(16#000000#, 22);
      SDFCummutator_btf1_im_dly <= to_signed(16#000000#, 22);
