-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_QUAD_DETERM1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_QUAD_DETERM1_block
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_2/CordicRotate/QUAD_MAP/QUAD_DETERM1
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_QUAD_DETERM1_block IS
...
END ofdm_rx_src_QUAD_DETERM1_block;


ARCHITECTURE rtl OF ofdm_rx_src_QUAD_DETERM1_block IS
...
BEGIN
  ...
  lib_ofdmrx_c14_QUAD_DETERM1_output : PROCESS (ang_in_signed)
  ...
  BEGIN
    ...
    END CASE;
    QUAD_tmp <= QUAD1;
  END PROCESS lib_ofdmrx_c14_QUAD_DETERM1_output;
