-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_pilotGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_pilotGen
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_1/PilotCtrlGen/pilotGen
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_pilotGen IS
...
END ofdm_rx_src_pilotGen;


ARCHITECTURE rtl OF ofdm_rx_src_pilotGen IS

  -- Component Declarations
  COMPONENT ofdm_rx_src_ToComplex1
  ...
  FOR ALL : ofdm_rx_src_ToComplex1
    USE ENTITY work.ofdm_rx_src_ToComplex1(rtl);
...
BEGIN
  u_ToComplex1 : ofdm_rx_src_ToComplex1
  ...
  Logical_Operator3_out1_1 <= Logical_Operator3_out1 WHEN enb_1_384_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' AND Logical_Operator3_out1_1 = '1' THEN
