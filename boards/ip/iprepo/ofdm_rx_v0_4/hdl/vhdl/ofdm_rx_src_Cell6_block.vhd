-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\OFDM_rx\hdlsrc\OFDM_Rx_HW\ofdm_rx_src_Cell6_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_rx_src_Cell6_block
-- Source Path: OFDM_Rx_HW/OFDMRx/PhaseTracking_2/CordicRotate/Cell6
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_rx_src_Cell6_block IS
...
END ofdm_rx_src_Cell6_block;


ARCHITECTURE rtl OF ofdm_rx_src_Cell6_block IS
...
BEGIN
  ...
  Shift_Arithmetic1_out1 <= SHIFT_RIGHT(Y_in_0_signed, 6);
  ...
  Shift_Arithmetic_out1 <= SHIFT_RIGHT(X_in_0_signed, 6);
  ...
  ANGLE_out1 <= to_signed(16#003FFF#, 23);
