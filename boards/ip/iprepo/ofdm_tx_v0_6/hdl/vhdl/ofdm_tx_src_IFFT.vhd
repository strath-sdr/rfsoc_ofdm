-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_IFFT.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  preambleValidIn_2 <= preambleValidIn_1 WHEN enb_1_384_1 = '1' ELSE
      NOT_bypass_reg;
  ...
  dataValidIn_2 <= dataValidIn_1 WHEN enb_1_384_1 = '1' ELSE
  ...
  Delay1_out1_3 <= Delay1_out1_2 WHEN enb_1_384_1 = '1' ELSE
