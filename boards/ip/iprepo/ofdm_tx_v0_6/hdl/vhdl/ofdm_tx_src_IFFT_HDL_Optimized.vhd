-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_IFFT_HDL_Optimized.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_IFFT_HDL_Optimized
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized
-- Hierarchy Level: 2
-- 
-- FFT HDL Optimized
-- 
...
ENTITY ofdm_tx_src_IFFT_HDL_Optimized IS
...
END ofdm_tx_src_IFFT_HDL_Optimized;


ARCHITECTURE rtl OF ofdm_tx_src_IFFT_HDL_Optimized IS

  -- Component Declarations
  COMPONENT ofdm_tx_src_RADIX22FFT_CTRL1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_1_1_re                     :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dout_1_1_im                     :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dout_1_1_vld                    :   OUT   std_logic;
          dinXTwdl_1_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT ofdm_tx_src_RADIX22FFT_CTRL1_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_TWDLROM_3_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_CTRL1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_CTRL1_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_TWDLROM_5_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_CTRL1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_CTRL1_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  COMPONENT ofdm_tx_src_RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
          dout_5_1_re                     :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dout_5_1_im                     :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dout_5_1_vld                    :   IN    std_logic;
          ...
          softReset                       :   IN    std_logic;
          dout_6_1_re                     :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dout_6_1_im                     :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          dout_6_1_vld                    :   OUT   std_logic;
          dinXTwdl_6_1_vld                :   OUT   std_logic
          );
  END COMPONENT;

  COMPONENT ofdm_tx_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
  ...
  FOR ALL : ofdm_tx_src_RADIX22FFT_CTRL1_1
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_CTRL1_1(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_SDF1_1
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_SDF1_1(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_CTRL1_2
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_CTRL1_2(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_SDF2_2
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_SDF2_2(rtl);

  FOR ALL : ofdm_tx_src_TWDLROM_3_1
    USE ENTITY work.ofdm_tx_src_TWDLROM_3_1(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_CTRL1_3
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_CTRL1_3(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_SDF1_3
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_SDF1_3(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_CTRL1_4
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_CTRL1_4(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_SDF2_4
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_SDF2_4(rtl);

  FOR ALL : ofdm_tx_src_TWDLROM_5_1
    USE ENTITY work.ofdm_tx_src_TWDLROM_5_1(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_CTRL1_5
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_CTRL1_5(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_SDF1_5
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_SDF1_5(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_CTRL1_6
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_CTRL1_6(rtl);

  FOR ALL : ofdm_tx_src_RADIX22FFT_SDF2_6
    USE ENTITY work.ofdm_tx_src_RADIX22FFT_SDF2_6(rtl);

  FOR ALL : ofdm_tx_src_RADIX2FFT_bitNatural
    USE ENTITY work.ofdm_tx_src_RADIX2FFT_bitNatural(rtl);
  ...
  SIGNAL dout_2_1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_2_1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL intdelay_reg_4                   : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL din_3_1_re_dly                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL intdelay_reg_5                   : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL din_3_1_im_dly                   : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_4_1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_4_1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL intdelay_reg_7                   : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL din_5_1_re_dly                   : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL intdelay_reg_8                   : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL din_5_1_im_dly                   : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_re1                         : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_im1                         : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_vld1                        : std_logic;

BEGIN
  u_CTRL1_1_1 : ofdm_tx_src_RADIX22FFT_CTRL1_1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_1_1 : ofdm_tx_src_RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
  ...
  u_CTRL2_2_1 : ofdm_tx_src_RADIX22FFT_CTRL1_2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : ofdm_tx_src_RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_1_1_re => dout_1_1_re,  -- sfix16_En14
  ...
  u_twdlROM_3_1 : ofdm_tx_src_TWDLROM_3_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : ofdm_tx_src_RADIX22FFT_CTRL1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
  ...
  u_SDF1_3_1 : ofdm_tx_src_RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              din_3_1_re_dly => std_logic_vector(din_3_1_re_dly),  -- sfix16_En14
              din_3_1_im_dly => std_logic_vector(din_3_1_im_dly),  -- sfix16_En14
  ...
  u_CTRL2_4_1 : ofdm_tx_src_RADIX22FFT_CTRL1_4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : ofdm_tx_src_RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_3_1_re => dout_3_1_re,  -- sfix16_En14
  ...
  u_twdlROM_5_1 : ofdm_tx_src_TWDLROM_5_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : ofdm_tx_src_RADIX22FFT_CTRL1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
  ...
  u_SDF1_5_1 : ofdm_tx_src_RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              din_5_1_re_dly => std_logic_vector(din_5_1_re_dly),  -- sfix16_En14
              din_5_1_im_dly => std_logic_vector(din_5_1_im_dly),  -- sfix16_En14
  ...
  u_CTRL2_6_1 : ofdm_tx_src_RADIX22FFT_CTRL1_6
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : ofdm_tx_src_RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_5_1_re => dout_5_1_re,  -- sfix16_En14
  ...
  u_NaturalOrder_Stage : ofdm_tx_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              dout_6_1_re => dout_6_1_re,  -- sfix16_En14
