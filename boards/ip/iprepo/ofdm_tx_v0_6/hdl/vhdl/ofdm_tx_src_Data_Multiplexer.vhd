-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_Data_Multiplexer.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator/Data Multiplexer
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  lib_ofdmtx_c2_Data_Multiplexer_output : PROCESS (dataready, lts_signed, ltsval, pilots_im_signed, pilots_re_signed, pval,
  ...
  BEGIN
    ...
    ELSE 
      ...
      data_im_tmp <= to_signed(16#0000#, 16);
    END IF;
  END PROCESS lib_ofdmtx_c2_Data_Multiplexer_output;
