-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_SDF2_4
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF2_4
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_SDF2_4 IS
...
END ofdm_tx_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT ofdm_tx_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : ofdm_tx_src_SDFCommutator4
    USE ENTITY work.ofdm_tx_src_SDFCommutator4(rtl);
...
BEGIN
  u_dataMEM_im_0_4 : ofdm_tx_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_4 : ofdm_tx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : ofdm_tx_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
