-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_SDF1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_SDF1_1
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF1_1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_SDF1_1 IS
...
END ofdm_tx_src_RADIX22FFT_SDF1_1;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_SDF1_1 IS
  ...
  COMPONENT ofdm_tx_src_SDFCommutator1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : ofdm_tx_src_SDFCommutator1
    USE ENTITY work.ofdm_tx_src_SDFCommutator1(rtl);
  ...
  SIGNAL dout_1_1_re_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_1_1_im_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_dataMEM_im_0_1 : ofdm_tx_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_1_generic : ofdm_tx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 5,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_1 : ofdm_tx_src_SDFCommutator1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_384_0 => enb_1_384_0,
              ...
              wrAddr => wrAddr,  -- ufix5
              wrEnb => wrEnb,
              dout_1_1_re => dout_1_1_re_tmp,  -- sfix16_En14
              dout_1_1_im => dout_1_1_im_tmp,  -- sfix16_En14
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' THEN
        dinXTwdl_re <= din_1_1_re_dly_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' THEN
        dinXTwdl_im <= din_1_1_im_dly_signed;
      END IF;
    END IF;
