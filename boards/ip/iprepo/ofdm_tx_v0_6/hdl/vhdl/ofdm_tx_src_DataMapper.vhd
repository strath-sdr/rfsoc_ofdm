-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_DataMapper.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/SCMapper/DataMapper
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  READ_CTRL2_out1_1 <= READ_CTRL2_out1_unsigned WHEN enb_1_384_1 = '1' ELSE
