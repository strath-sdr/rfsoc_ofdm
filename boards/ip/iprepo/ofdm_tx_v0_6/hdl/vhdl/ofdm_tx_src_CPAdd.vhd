-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_CPAdd.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/CPAdd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  dataIn_re_2 <= dataIn_re_1 WHEN enb_1_384_1 = '1' ELSE
      Dual_Port_RAM1_bypass_reg_re;
  
  dataIn_im_2 <= dataIn_im_1 WHEN enb_1_384_1 = '1' ELSE
  ...
  preambValid_2 <= preambValid_1 WHEN enb_1_384_1 = '1' ELSE
      AND11_bypass_reg;
  ...
  dataIn_re_3 <= dataIn_re_1 WHEN enb_1_384_1 = '1' ELSE
      Dual_Port_RAM_bypass_reg_re;
  
  dataIn_im_3 <= dataIn_im_1 WHEN enb_1_384_1 = '1' ELSE
  ...
  preambValid_3 <= preambValid_1 WHEN enb_1_384_1 = '1' ELSE
      AND1_bypass_reg;
  ...
  dataIn_re_4 <= dataIn_re_1 WHEN enb_1_384_1 = '1' ELSE
      Dual_Port_RAM2_bypass_reg_re;
  
  dataIn_im_4 <= dataIn_im_1 WHEN enb_1_384_1 = '1' ELSE
