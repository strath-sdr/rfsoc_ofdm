-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_DataGenerator.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_tx_src_DataGenerator IS
  ...
  SIGNAL RF_Signal_Generator_out1         : std_logic;
  ...
  SIGNAL RF_Signal_Generator_out2_re_2    : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL RF_Signal_Generator_out2_im_2    : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL delayMatch5_reg                  : std_logic_vector(0 TO 11);  -- ufix1 [12]
  ...
  SIGNAL RF_Signal_Generator_out1_1       : std_logic;
  SIGNAL RF_Signal_Generator_out1_2       : std_logic;
  SIGNAL Upsample_bypass_reg              : std_logic;  -- ufix1
  SIGNAL RF_Signal_Generator_out1_3       : std_logic;
...
BEGIN
  u_RF_Signal_Generator : ofdm_tx_src_RF_Signal_Generator
    PORT MAP( clk => clk,
              ...
              Enable => dataReady_1,
              m_axis_tvalid => RF_Signal_Generator_out1,
  ...
  u_Data_Multiplexer : ofdm_tx_src_Data_Multiplexer
    PORT MAP( symbols_re => std_logic_vector(RF_Signal_Generator_out2_re_2),  -- sfix16_En14
              symbols_im => std_logic_vector(RF_Signal_Generator_out2_im_2),  -- sfix16_En14
              dataready => dataReady_3,
  ...
  modScheme_3 <= modScheme_2 WHEN enb_1_384_1 = '1' ELSE
      Delay2_bypass_reg;
  ...
  RF_Signal_Generator_out2_re_1 <= signed(RF_Signal_Generator_out2_re);

  RF_Signal_Generator_out2_im_1 <= signed(RF_Signal_Generator_out2_im);

  delayMatch1_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      RF_Signal_Generator_out2_re_2 <= to_signed(16#0000#, 16);
      RF_Signal_Generator_out2_im_2 <= to_signed(16#0000#, 16);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        RF_Signal_Generator_out2_re_2 <= RF_Signal_Generator_out2_re_1;
        RF_Signal_Generator_out2_im_2 <= RF_Signal_Generator_out2_im_1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        delayMatch5_reg(0) <= pilotValid_2;
        delayMatch5_reg(1 TO 11) <= delayMatch5_reg(0 TO 10);
      END IF;
    END IF;
  END PROCESS delayMatch5_process;

  pilotValid_3 <= delayMatch5_reg(11);
  ...
  RF_Signal_Generator_out1_1 <= RF_Signal_Generator_out1;

  out_3_pipe_in_pipe_process : PROCESS (clk, reset)
  BEGIN
    IF reset = '1' THEN
      RF_Signal_Generator_out1_2 <= '0';
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_32_0 = '1' THEN
        RF_Signal_Generator_out1_2 <= RF_Signal_Generator_out1_1;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_1 = '1' THEN
        Upsample_bypass_reg <= RF_Signal_Generator_out1_2;
      END IF;
    END IF;
  END PROCESS Upsample_bypass_process;

  
  RF_Signal_Generator_out1_3 <= RF_Signal_Generator_out1_2 WHEN enb_1_384_1 = '1' ELSE
      Upsample_bypass_reg;
  ...
  symValidOut <= RF_Signal_Generator_out1_3;
