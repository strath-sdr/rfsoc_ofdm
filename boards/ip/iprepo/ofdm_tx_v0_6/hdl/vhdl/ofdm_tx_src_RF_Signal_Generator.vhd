-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RF_Signal_Generator.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator/RF Signal Generator
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  AND_out1 <= Enable AND Delay5_out1;
