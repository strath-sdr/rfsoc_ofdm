-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_CTRL1_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_CTRL1_4
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_CTRL1_4
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_CTRL1_4 IS
...
END ofdm_tx_src_RADIX22FFT_CTRL1_4;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_CTRL1_4 IS
  ...
  SIGNAL rd_4_Addr_tmp                    : unsigned(1 DOWNTO 0);  -- ufix2
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_4_Enb <= '0';
        IF (dout_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#3#, 2))) = '1' THEN 
