-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_complement_im1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_complement_im1
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator/RF Signal Generator/Variable Modulator/QAM1024 Generator/complement_im1
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_complement_im1 IS
  PORT( d_in                              :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
        d_out                             :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
        );
END ofdm_tx_src_complement_im1;


ARCHITECTURE rtl OF ofdm_tx_src_complement_im1 IS
