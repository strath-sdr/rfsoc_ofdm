-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_SDF2_6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_SDF2_6
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF2_6
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_SDF2_6 IS
...
END ofdm_tx_src_RADIX22FFT_SDF2_6;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_SDF2_6 IS

  -- Component Declarations
  COMPONENT ofdm_tx_src_SDFCommutator6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_384_0                     :   IN    std_logic;
          dout_5_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : ofdm_tx_src_SDFCommutator6
    USE ENTITY work.ofdm_tx_src_SDFCommutator6(rtl);

  -- Signals
  SIGNAL dout_5_1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_5_1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_6_1_re_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dout_6_1_im_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_SDFCOMMUTATOR_6 : ofdm_tx_src_SDFCommutator6
    PORT MAP( clk => clk,
              reset => reset,
              ...
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_6_1_re => dout_6_1_re_tmp,  -- sfix16_En14
              dout_6_1_im => dout_6_1_im_tmp,  -- sfix16_En14
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' THEN
        din_re_dly1 <= dout_5_1_re_signed;
      END IF;
    END IF;
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' THEN
        din_im_dly1 <= dout_5_1_im_signed;
      END IF;
    END IF;
  ...
  Radix22ButterflyG2_output : PROCESS (Radix22ButterflyG2_btf1_im_reg, Radix22ButterflyG2_btf1_re_reg,
       ...
       btfin_re, btfin_vld, dinVld, dout_5_1_im_signed, dout_5_1_re_signed,
       multiply_6_J, x_im_dly, x_re_dly, x_vld_dly)
  ...
  BEGIN
    ...
    Radix22ButterflyG2_din_re_dly_next <= dout_5_1_re_signed;
    Radix22ButterflyG2_din_im_dly_next <= dout_5_1_im_signed;
