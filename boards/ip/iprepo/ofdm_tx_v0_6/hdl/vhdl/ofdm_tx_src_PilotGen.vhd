-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_PilotGen.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator/PilotGen
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_tx_src_PilotGen IS
  ...
  SIGNAL reduced_reg                      : std_logic_vector(0 TO 10);  -- ufix1 [11]
...
BEGIN
  ...
  pilotValidIn_3 <= pilotValidIn_1 WHEN enb_1_384_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_384_0 = '1' AND pilotValidIn_3 = '1' THEN
