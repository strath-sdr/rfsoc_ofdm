-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_CTRL1_3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_CTRL1_3
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_CTRL1_3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_CTRL1_3 IS
...
END ofdm_tx_src_RADIX22FFT_CTRL1_3;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_CTRL1_3 IS
  ...
  SIGNAL rd_3_Addr_tmp                    : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_3_Enb <= '0';
        IF (dinXTwdl_3_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#7#, 3))) = '1' THEN 
