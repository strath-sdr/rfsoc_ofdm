-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_CTRL1_2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_CTRL1_2
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_CTRL1_2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_CTRL1_2 IS
...
END ofdm_tx_src_RADIX22FFT_CTRL1_2;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_CTRL1_2 IS
  ...
  SIGNAL rd_2_Addr_tmp                    : unsigned(3 DOWNTO 0);  -- ufix4
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF (dout_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#F#, 4))) = '1' THEN 
