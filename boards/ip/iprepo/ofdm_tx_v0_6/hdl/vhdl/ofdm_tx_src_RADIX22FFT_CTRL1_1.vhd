-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_RADIX22FFT_CTRL1_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_RADIX22FFT_CTRL1_1
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_CTRL1_1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_RADIX22FFT_CTRL1_1 IS
...
END ofdm_tx_src_RADIX22FFT_CTRL1_1;


ARCHITECTURE rtl OF ofdm_tx_src_RADIX22FFT_CTRL1_1 IS
  ...
  SIGNAL rd_1_Addr_tmp                    : unsigned(4 DOWNTO 0);  -- ufix5
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF (dinXTwdl_1_1_vld AND hdlcoder_to_stdlogic(SDFController_wrCount = to_unsigned(16#1F#, 5))) = '1' THEN 
