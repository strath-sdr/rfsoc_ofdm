-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_Subsystem.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator/RF Signal Generator/Random Generator/Subsystem
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_tx_src_Subsystem IS
  ...
  -- Signals
  SIGNAL enb_1_384_0_gated                : std_logic;
...
BEGIN
  ...
  enb_1_384_0_gated <= Enable_out2 AND enb_1_384_0;
