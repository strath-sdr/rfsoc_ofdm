-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_SDFCommutator1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_SDFCommutator1
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_SDFCommutator1 IS
...
END ofdm_tx_src_SDFCommutator1;


ARCHITECTURE rtl OF ofdm_tx_src_SDFCommutator1 IS
  ...
  SIGNAL dinXTwdlf_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinXTwdlf_im_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  ...
  SIGNAL dout_1_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_1_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14

BEGIN
  u_dataXMEM_re_0_1 : ofdm_tx_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_1 : ofdm_tx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    CASE SDFCummutator_mem_btf_switch IS
      ...
      WHEN "01" =>
        SDFCummutator_mem_btf_switch_next <= to_unsigned(16#1#, 2);
        SDFCummutator_rdEnb_xmem_next <= '0';
        IF (hdlcoder_to_stdlogic(SDFCummutator_rdCnt = to_unsigned(16#1F#, 5)) AND btf_vld) = '1' THEN 
