-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_Mux2_block.vhd
...
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/SCMapper/Mux2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  lib_ofdmtx_c7_Mux2_output : PROCESS (dataVal, data_im_signed, data_re_signed, preambVal, preamb_im_signed,
       preamb_re_signed)
  BEGIN
    IF preambVal = '1' THEN 
    ...
    END IF;
  END PROCESS lib_ofdmtx_c7_Mux2_output;
