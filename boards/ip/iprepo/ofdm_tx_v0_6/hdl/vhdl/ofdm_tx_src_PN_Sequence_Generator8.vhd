-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_PN_Sequence_Generator8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_PN_Sequence_Generator8
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/DataGenerator/RF Signal Generator/Random Generator/Subsystem/PN Sequence 
-- Generator
-- Hierarchy Level: 5
-- 
...
ENTITY ofdm_tx_src_PN_Sequence_Generator8 IS
...
END ofdm_tx_src_PN_Sequence_Generator8;


ARCHITECTURE rtl OF ofdm_tx_src_PN_Sequence_Generator8 IS

  -- Constants
  CONSTANT VectorTDL_data                 : std_logic_vector(0 TO 12) := 
    ('1', '1', '0', '1', '1', '1', '1', '1', '0', '0', '0', '1', '1');  -- ufix1 [13]
