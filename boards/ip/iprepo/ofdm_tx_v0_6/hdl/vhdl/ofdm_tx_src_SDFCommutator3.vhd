-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_SDFCommutator3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_SDFCommutator3
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_SDFCommutator3 IS
...
END ofdm_tx_src_SDFCommutator3;


ARCHITECTURE rtl OF ofdm_tx_src_SDFCommutator3 IS
  ...
  SIGNAL dout_3_1_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dout_3_1_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En14

BEGIN
  u_dataXMEM_re_0_3 : ofdm_tx_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_3 : ofdm_tx_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
