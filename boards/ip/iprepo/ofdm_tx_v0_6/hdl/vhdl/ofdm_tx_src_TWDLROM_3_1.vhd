-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_fixed_point\ofdm_tx_src_TWDLROM_3_1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_src_TWDLROM_3_1
-- Source Path: OFDM_Tx_Rx_fixed_point/OFDMTx/IFFT/IFFT HDL Optimized/TWDLROM_3_1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_src_TWDLROM_3_1 IS
...
END ofdm_tx_src_TWDLROM_3_1;


ARCHITECTURE rtl OF ofdm_tx_src_TWDLROM_3_1 IS
...
BEGIN
  ...
  BEGIN
    ...
    END IF;
    IF (dout_2_1_vld AND hdlcoder_to_stdlogic(Radix22TwdlMapping_cnt > to_unsigned(16#E#, 4))) = '1' THEN 
