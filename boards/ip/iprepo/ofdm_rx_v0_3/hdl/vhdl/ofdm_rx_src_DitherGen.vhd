-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_DitherGen.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/Synchronisation/CoarseFreqCorr/NCO HDL Optimized/DitherGen
-- Hierarchy Level: 4
-- 
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' AND validIn = '1' THEN
        pn_reg <= pn_newvalue4;
      END IF;
    END IF;
