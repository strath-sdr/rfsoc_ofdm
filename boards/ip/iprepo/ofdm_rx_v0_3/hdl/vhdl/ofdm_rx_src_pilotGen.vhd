-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_rx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_rx_src_pilotGen.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMRx/PhaseTracking_1/PilotCtrlGen/pilotGen
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Logical_Operator3_out1_1 <= Logical_Operator3_out1 WHEN enb_1_192_1 = '1' ELSE
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' AND Logical_Operator3_out1_1 = '1' THEN
