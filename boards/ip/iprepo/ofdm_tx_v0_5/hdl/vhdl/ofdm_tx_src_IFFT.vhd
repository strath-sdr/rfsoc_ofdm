...
BEGIN
  ...
  preambleValidIn_2 <= preambleValidIn_1 WHEN enb_1_192_1 = '1' ELSE
      NOT_bypass_reg;
  ...
  dataValidIn_2 <= dataValidIn_1 WHEN enb_1_192_1 = '1' ELSE
  ...
  Delay1_out1_3 <= Delay1_out1_2 WHEN enb_1_192_1 = '1' ELSE
