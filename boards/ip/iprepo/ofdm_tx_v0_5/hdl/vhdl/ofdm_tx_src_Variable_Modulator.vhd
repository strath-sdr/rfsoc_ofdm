-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_Variable_Modulator.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/DataGenerator/RF Signal Generator/Variable Modulator
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  ...
  Bit_Slice3_out1 <= Select_unsigned(2 DOWNTO 0);
  ...
  Multiport_Switch1_out1 <= Constant1_out1_dtc WHEN Bit_Slice3_out1 = to_unsigned(16#0#, 3) ELSE
      QPSK_Generator_out2_signed WHEN Bit_Slice3_out1 = to_unsigned(16#1#, 3) ELSE
      alpha8PSK_Generator_out2_signed WHEN Bit_Slice3_out1 = to_unsigned(16#2#, 3) ELSE
      QAM16_Generator_out2_signed WHEN Bit_Slice3_out1 = to_unsigned(16#3#, 3) ELSE
      QAM32_Generator_out2_signed WHEN Bit_Slice3_out1 = to_unsigned(16#4#, 3) ELSE
      QAM64_Generator_out2_signed WHEN Bit_Slice3_out1 = to_unsigned(16#5#, 3) ELSE
      QAM128_Generator_out2_signed WHEN Bit_Slice3_out1 = to_unsigned(16#6#, 3) ELSE
      QAM256_Generator_out2_signed;
  ...
  Multiport_Switch_out1 <= BPSK_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#0#, 3) ELSE
      QPSK_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#1#, 3) ELSE
      alpha8PSK_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#2#, 3) ELSE
      QAM16_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#3#, 3) ELSE
      QAM32_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#4#, 3) ELSE
      QAM64_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#5#, 3) ELSE
      QAM128_Generator_out1_signed WHEN Bit_Slice3_out1 = to_unsigned(16#6#, 3) ELSE
      QAM256_Generator_out1_signed;
