-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\OFDM_tx\hdlsrc\OFDM_Tx_Rx_HW\ofdm_tx_src_Random_Generator.vhd
...
-- Source Path: OFDM_Tx_Rx_HW/OFDMTx/DataGenerator/RF Signal Generator/Random Generator
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF ofdm_tx_src_Random_Generator IS
  ...
  SIGNAL Delay_iv                         : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_delOut                     : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_ectrl                      : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_toDelay                    : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_bypassIn                   : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_out1                       : unsigned(7 DOWNTO 0);  -- uint8
  SIGNAL Delay_last_value                 : unsigned(7 DOWNTO 0);  -- uint8
...
BEGIN
  ...
  Bit_Concat1_out1 <= unsigned'(Subsystem_out1 & Subsystem_out2 & Subsystem_out3 & Subsystem_out4 & Subsystem_out5 & Subsystem_out6 & Subsystem_out7 & Subsystem_out8);

  Delay_iv <= to_unsigned(16#00#, 8);
  ...
  BEGIN
    IF reset = '1' THEN
      Delay_delOut <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
  ...
  BEGIN
    IF reset = '1' THEN
      Delay_last_value <= to_unsigned(16#00#, 8);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_192_0 = '1' THEN
