-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Tx_HW\ofdm_tx_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_axi_lite
-- Source Path: ofdm_tx/ofdm_tx_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END ofdm_tx_axi_lite;


ARCHITECTURE rtl OF ofdm_tx_axi_lite IS

  -- Component Declarations
  COMPONENT ofdm_tx_addr_decoder
  ...
  COMPONENT ofdm_tx_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : ofdm_tx_addr_decoder
    USE ENTITY work.ofdm_tx_addr_decoder(rtl);

  FOR ALL : ofdm_tx_axi_lite_module
    USE ENTITY work.ofdm_tx_axi_lite_module(rtl);
  ...
  SIGNAL write_modScheme_tmp              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_gain_tmp                   : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_ofdm_tx_addr_decoder_inst : ofdm_tx_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_modScheme => write_modScheme_tmp,  -- ufix32
              write_enable => write_enable,  -- ufix1
              write_gain => write_gain_tmp  -- ufix32
              );

  u_ofdm_tx_axi_lite_module_inst : ofdm_tx_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_modScheme <= write_modScheme_tmp;

  write_gain <= write_gain_tmp;
