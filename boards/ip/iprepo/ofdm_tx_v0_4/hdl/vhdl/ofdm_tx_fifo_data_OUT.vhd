-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Tx_HW\ofdm_tx_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_fifo_data_OUT
-- Source Path: ofdm_tx/ofdm_tx_axi4_stream_master/ofdm_tx_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_fifo_data_OUT IS
...
END ofdm_tx_fifo_data_OUT;


ARCHITECTURE rtl OF ofdm_tx_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT ofdm_tx_SimpleDualPortRAM_generic
  ...
  FOR ALL : ofdm_tx_SimpleDualPortRAM_generic
    USE ENTITY work.ofdm_tx_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_ofdm_tx_fifo_data_OUT_classic_ram_generic : ofdm_tx_SimpleDualPortRAM_generic
