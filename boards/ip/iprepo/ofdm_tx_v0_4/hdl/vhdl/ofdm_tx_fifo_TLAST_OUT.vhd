-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\OFDM_Tx_HW\ofdm_tx_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: ofdm_tx_fifo_TLAST_OUT
-- Source Path: ofdm_tx/ofdm_tx_axi4_stream_master/ofdm_tx_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY ofdm_tx_fifo_TLAST_OUT IS
...
END ofdm_tx_fifo_TLAST_OUT;


ARCHITECTURE rtl OF ofdm_tx_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT ofdm_tx_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : ofdm_tx_SimpleDualPortRAM_singlebit
    USE ENTITY work.ofdm_tx_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_ofdm_tx_fifo_TLAST_OUT_classic_ram_singlebit : ofdm_tx_SimpleDualPortRAM_singlebit
