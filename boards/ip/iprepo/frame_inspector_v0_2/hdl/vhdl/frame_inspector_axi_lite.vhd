-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frame_inspector_test\frame_inspector_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frame_inspector_axi_lite
-- Source Path: frame_inspector/frame_inspector_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frame_inspector_axi_lite IS
...
END frame_inspector_axi_lite;


ARCHITECTURE rtl OF frame_inspector_axi_lite IS

  -- Component Declarations
  COMPONENT frame_inspector_addr_decoder
  ...
  COMPONENT frame_inspector_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : frame_inspector_addr_decoder
    USE ENTITY work.frame_inspector_addr_decoder(rtl);

  FOR ALL : frame_inspector_axi_lite_module
    USE ENTITY work.frame_inspector_axi_lite_module(rtl);
...
BEGIN
  u_frame_inspector_addr_decoder_inst : frame_inspector_addr_decoder
  ...
  u_frame_inspector_axi_lite_module_inst : frame_inspector_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
