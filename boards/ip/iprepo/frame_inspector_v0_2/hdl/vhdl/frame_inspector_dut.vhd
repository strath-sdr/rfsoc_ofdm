-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frame_inspector_test\frame_inspector_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frame_inspector_dut
-- Source Path: frame_inspector/frame_inspector_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END frame_inspector_dut;


ARCHITECTURE rtl OF frame_inspector_dut IS

  -- Component Declarations
  COMPONENT frame_inspector_src_fft_shift_di
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : frame_inspector_src_fft_shift_di
    USE ENTITY work.frame_inspector_src_fft_shift_di(rtl);
...
BEGIN
  u_frame_inspector_src_fft_shift_di : frame_inspector_src_fft_shift_di
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset => reset,
