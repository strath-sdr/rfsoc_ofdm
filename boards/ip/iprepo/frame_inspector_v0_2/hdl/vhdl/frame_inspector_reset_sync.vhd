-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\frame_inspector_test\frame_inspector_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frame_inspector_reset_sync
-- Source Path: frame_inspector/frame_inspector_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frame_inspector_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END frame_inspector_reset_sync;


ARCHITECTURE rtl OF frame_inspector_reset_sync IS
