-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\frame_inspector_shift\hdlsrc\frame_inspector_shift_test\frame_inspector_shift_src_fft_shift_di.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frame_inspector_shift_src_fft_shift_di
-- Source Path: frame_inspector_shift_test/fft_shift_di
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frame_inspector_shift_src_fft_shift_di IS
...
END frame_inspector_shift_src_fft_shift_di;


ARCHITECTURE rtl OF frame_inspector_shift_src_fft_shift_di IS

  -- Component Declarations
  COMPONENT frame_inspector_shift_src_control
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT frame_inspector_shift_src_SinglePortRAM_generic
  ...
  FOR ALL : frame_inspector_shift_src_control
    USE ENTITY work.frame_inspector_shift_src_control(rtl);

  FOR ALL : frame_inspector_shift_src_SinglePortRAM_generic
    USE ENTITY work.frame_inspector_shift_src_SinglePortRAM_generic(rtl);
...
BEGIN
  u_control : frame_inspector_shift_src_control
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Single_Port_RAM_System : frame_inspector_shift_src_SinglePortRAM_generic
  ...
  Constant1_out1 <= to_unsigned(16#003F#, 16);
