-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm\boards\ip\models\hdl_prj\frame_inspector_shift\hdlsrc\frame_inspector_shift_test\frame_inspector_shift_addr_decoder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: frame_inspector_shift_addr_decoder
-- Source Path: frame_inspector_shift/frame_inspector_shift_axi_lite/frame_inspector_shift_addr_decoder
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY frame_inspector_shift_addr_decoder IS
...
END frame_inspector_shift_addr_decoder;


ARCHITECTURE rtl OF frame_inspector_shift_addr_decoder IS
