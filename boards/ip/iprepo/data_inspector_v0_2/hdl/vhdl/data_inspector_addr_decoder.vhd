-- -------------------------------------------------------------
-- 
-- File Name: C:\Git\rfsoc_ofdm_workspace\models\hdl_prj\data_inspector\hdlsrc\data_inspector_test\data_inspector_addr_decoder.vhd
...
ARCHITECTURE rtl OF data_inspector_addr_decoder IS
  ...
  SIGNAL decode_rd_frame_size_1_1         : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  ...
  decode_rd_frame_size_1_1 <= decode_rd_ip_timestamp_1_1 WHEN decode_sel_frame_size_1_1 = '0' ELSE
      data_reg_frame_size_1_1;

  data_read <= std_logic_vector(decode_rd_frame_size_1_1);
